...
<div class="w950">
    ...
    <div class="link">
        ...
        <li><a href="queryAboutInfo.mht?msg=100" target="_blank">三好资本公告</a></li>
        <li><a href="queryAboutInfo.mht?msg=103" target="_blank">三好资本动态</a></li>
        <li><a href="queryAboutInfo.mht?msg=108" target="_blank">三好资本问答</a></li>
    ...
    <div class="copyright">
          <p> ${sitemap.certificate }&nbsp;|&nbsp;©2016&nbsp;${sitemap.regionName }</p>
