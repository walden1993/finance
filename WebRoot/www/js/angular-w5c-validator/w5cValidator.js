        ...
        var validatorFn = function () {
            ...
            this.defaultShowError = function (elem, errorMessages) {
                ...
                if (!this.isEmpty($group) && !$group.hasClass("has-error")) {
                    ...
                    $parent.after('<div class="w5c-error item assertive">' + errorMessages[0] + '</div>');
                    //$parent.parent().find(".w5c-error").html(errorMessages[0]);
                }
            };
            this.defaultRemoveError = function (elem) {
                ...
                if (!this.isEmpty($group) && $group.hasClass("has-error")) {
                    ...
                    $parent.next(".w5c-error").remove();
                    //$parent.parent().find(".w5c-error").html();
                }
            };
            this.options = {
                blurTrig   : false,
