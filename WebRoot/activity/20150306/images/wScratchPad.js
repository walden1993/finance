(function($)
{
	...
	{
		width		: 554,						// set width - best to match image width
		height		: 235,						// set height - best to match image height
		image		: null,		                // set image path
		image2		: "activity/20150306/images/scratchpad_bg.png",						// set overlay image path - if set color is not used
		color		: '#868483',				// set scratch color - if image2 is not set uses color
