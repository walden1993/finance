				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<s:if test="#bean.isLate==1">
							...
							<td>
							<a href="queryApplyDebtAuditDetail.mht?id=${id}&paramMap.borrowerName=${borrowerName}&paramMap.isLate=${isLate}&paramMap.alienatorName=${alienatorName}&paramMap.borrowTitle=${borrowTitle}"
							 target="main">
										审核</a>
					</td></tr>
				</s:iterator>
