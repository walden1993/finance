					...
					<div id="showcontent" style="width: auto; background-color: #FFF; padding: 10px;">
						...
						<td id="secodetble" style="width: 500px;" >
						  <table  border="0" cellspacing="1" cellpadding="3" >
							...
							<span style="cursor: pointer;" onclick="javascript:window.location.href='queryUserManageBaseInfoinnerU.mht?i=${UserMsgmap.id}';">个人基本信息</span></td>
		...
		<script>
		  $(function(){
		   ...
		   function userCash(){
		          ...
		          var id = ${map.userId};
			    	$.dispatchPost("queryUserCashInfo.mht",{userId:id},function (data){
