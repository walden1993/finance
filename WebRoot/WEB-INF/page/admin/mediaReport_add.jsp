...
<html>
	<head>
		...
		<script type="text/javascript"  src="../script/optiontransferselect.js"></script>
		<script>
		  var editor_content;
	...
	<body>
		<form id="addTeam" name="addTeam" action="addMediaReport.mht" method="post">
			<div id="right">
							...
							<tr>
								...
								<td align="left" class="f66">
									<select id="tb_newsType" name="paramMap.newsType"  >
                                        <option value="1" >三好资本动态</option>
                                        <option value="2" >互联网金融</option>
                                        <option value="3" >三好资本问答</option>
									 </select>
               ...
               doubleListValue="selectName"
                >
							...
							<tr>
                                ...
                                <td align="left" class="f66">
                                <s:select name="paramMap.state"  list="#{1:'隐藏',2:'开启'}" value="2"></s:select>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" class="f66">
                                <s:select name="paramMap.stick"  list="#{1:'否',2:'是'}"  value="1"></s:select>
                                </td>
                            </tr>
