		...
		<script type="text/javascript">
			$(function(){				
				...
				$("#bt_search").click(function(){
	                 ...
	                 param["paramMap.artitle"] = $("#artitle").val();
	                 ...
	                 /**if(isBlank(param["paramMap.createTimeStart"]) && isBlank(param["paramMap.createTimeEnd"])){
	                	 alert("起止日期跟截至日期不能同时为空");
	                	 return ;
	                 }
	                 if( !isBlank(param["paramMap.createTimeStart"]) && !isBlank(param["paramMap.createTimeEnd"])  &&  param["paramMap.createTimeStart"]>param["paramMap.createTimeEnd"]){
	                     alert("起始日期不能小于截至日期")
	                     return;
	                 }*/
	                 initListInfo(param);
			...
			function initListInfo(praData){							    
		 		$.dispatchPost("queryMediaReportListPage.mht",praData,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteMediaReport.mht?id="+ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteMediaReport.mht?id="+id;
		 	}
						...
						<table style="margin-bottom: 8px;" cellspacing="0" cellpadding="0"
                            ...
                            <tbody>
                                ...
                                <td class="f66" align="left" width="80%" height="36px">
                                        内容 ：<input id="content" name="paramMap.content"  placeholder="标题、正文关键字"  type="text"/>&nbsp;&nbsp;
                                        标题 ：<input id="artitle" name="paramMap.content"  type="text"/>
                                        类型 ：<s:select list="#{0:'请选择',1:'三好资本动态',2:'互联网金融',3:'三好资本问答'}"  id="newsType"></s:select>&nbsp;&nbsp;
                                        发布时间：<input id="createTimeStart"  class="Wdate" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  name="paramMap.createTime" type="text"/>&nbsp;&nbsp;
