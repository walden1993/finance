...
<body>
        ...
        <div align="center">
             <s:form action="batchCharge.mht"  id="batchCharge"  enctype="multipart/form-data"  method="post">
             <table>
                <tr>
                    <td align="right"><h5>导入充值清单：</h5></td>
                    <td><s:file label="导入"  name="files.files"  value="导入"  id="files" ></s:file></td>
                </tr>
                <tr>
                    <td><input type="button" id="bind" value="充值"  /></td><%--
		...
		<script type="text/javascript">
			 function downModel(){
				window.location.href = encodeURI(encodeURI("downBatchChargeModel.mht"));
			}
			$(function(){
