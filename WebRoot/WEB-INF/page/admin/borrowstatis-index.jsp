						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									借款类型：
									<s:select id="borrowWay" list="#{-1:'--请选择--',1:'净值借款',2:'秒还借款',3:'信用借款',4:'实地考察借款',5:'机构担保借款',6:'流转标借款',7:'债权转让借款'}"></s:select>
...
<script type="text/javascript">
			$(function(){
				...
				$("#excel").attr("disabled",true);
				     window.location.href=encodeURI(encodeURI("exportborrowStatis.mht?borrowTitle="+$("#borrowTitle").val()+"&&borrower="+$("#borrower").val()+"&&timeStart="+$("#timeStart").val()+"&&timeEnd="+$("#timeEnd").val()+"&&borrowWay="+$("#borrowWay").val()));
			...
			function initListInfo(praData){
				...
				praData["paramMap.borrowWay"] = $("#borrowWay").val();
		 		$.dispatchPost("borrowStatisList.mht",praData,initCallBack);
		 	}
