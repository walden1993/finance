			...
			<tbody>
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<td>
						   <a href="../financeDetail.mht?id=${bean.borrowId}" target="_blank">${bean.borrowTitle}</a>
						</td>
						<td>
						${bean.repayPeriod}
					    </td>
					...
					<td>
						 <a href="repaymentDetail.mht?id=${bean.id}">查看</a> 
					</td>
					</tr>
				</s:iterator>
				</s:else>
				...
				<td></td><td></td>
				<td  align="center" ><fmt:formatNumber value="${lateAmount }" type="number" pattern="￥0.00" /></td><td></td><td></td><td></td><td></td>
				</tr>
			</tbody>
		</table><p/>
