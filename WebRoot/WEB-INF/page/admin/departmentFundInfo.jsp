		...
		$("#excel")
				.click(
						function() {
							...
							window.location.href = "exportDepartmentFundInfo.mht?pageBean.pageNum=1000 &&paramMap.department="
									+ $("#department").val()
                                    ...
                                    + $("#investTimeEnd").val()
                                    + "&paramMap.rechargeTimeStart="
                                    + $("#rechargeTimeStart").val()
                                    + "&paramMap.rechargeTimeEnd="
                                    + $("#rechargeTimeEnd").val();
	...
	<table id="help" style="width: 100%; color: #333333;" cellspacing="1"
		...
		<tbody>
			<tr class=gvHeader>
				...
				<th style="width: 5%" scope="col">人数</th>
