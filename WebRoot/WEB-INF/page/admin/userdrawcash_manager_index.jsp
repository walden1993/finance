...
<html>
	<head>
	   ...
	   function initListInfo(praData) {
	   		...
	   		$.dispatchPost("queryDrawCashManagerInfo.mht",param,initCallBack);
   		}
   		...
   		function deleteById(ids,cashStatus){
	 		...
	 		if(window.confirm("确定要"+msg+"吗?")){
	 			window.location.href = "updateUserCashStatus.mht?id="+ids+"&cashStatus="+cashStatus;
	 		}
   		}
				...
				<div>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<td width="100" height="28" align="center" bgcolor="#8594A9"
									class="white12">
									<a href="queryGroupInit.mht">用户组列表</a>
								</td>
								<td width="2px">
									&nbsp;
								</td>
