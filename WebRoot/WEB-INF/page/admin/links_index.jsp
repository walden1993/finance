	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){
		 		$.dispatchPost("queryLinksListPageBack.mht",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteLinks.mht?commonId=" + ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteLinks.mht?commonId="+id;
		 	}
