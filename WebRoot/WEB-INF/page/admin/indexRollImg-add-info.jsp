...
<html>
	...
	<body>
		<form id="addLinks" name="addLinks" action="addIndexRollImgInfo.mht" method="post">
			<div id="right">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="queryIndexRollImgInit.mht">图片管理</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" class="main_alll_h2">
									<a href="addIndexRollImgInit.mht">添加图片</a>
								</td>
								<td>
									&nbsp;
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td>
								<s:select id="paramMap.cardStatus"  name="paramMap.cardStatus" list="#{-1:'-请选择-',2:'投资广告',3:'首页滚动图片',4:'APP滚动图片'}" ></s:select>
