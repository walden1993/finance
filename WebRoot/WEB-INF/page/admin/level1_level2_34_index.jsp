	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["dateStatus"] = $("#dateStatus").val();
	   		$.dispatchPost("queryLevel1level4Info.mht",praData,initCallBack);
   		}
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="150" height="28"  class="xxk_all_a">
								<a href="queryAwardLevel1Init.mht?level1userId=${level1userId }">团队长提成奖励明细</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="150" height="28"  class="xxk_all_a">
								<a href="queryLeve2AwardInit.mht?parentId=${level1userId }">经纪人提成奖励</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="150" height="28" class="${level==3?'main_alll_h2':'xxk_all_a' }">
								<a href="queryLevel1level3Init.mht?level1userId=${level1userId }">投资人提成奖励</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="150" height="28" class="${level==3?'xxk_all_a':'main_alll_h2' }">
								<a href="queryLevel1level4Init.mht?level1userId=${level1userId }">理财人提成奖励</a>
							</td>
							<td>
								&nbsp;
							</td>
