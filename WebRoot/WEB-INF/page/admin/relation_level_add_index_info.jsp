...
<script type="text/javascript">
 $(function(){
   ...
   window.location.href=encodeURI(encodeURI("exportRechargeRecord.mht?userName="+$("#userName").val()+"&&rechargeTime="+$("#rechargeTime").val()+"&&rechargeType="+$("#rechargeType").val()+"&&statss="+$("#status").val()));
   });
 });
</script>
	<div>
