					...
					<div>
						<table  border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100px;" height="28" align="center" 
									class="xxk_all_a">
									<a href="publishCirculation.mht">代发流转标</a>
								</td>
								<td width="2px;">
									&nbsp;
								</td>
								<td width="100" height="28" align="center" 
									class="xxk_all_a">
									<a href="circulationRepayRecordInit.mht">流转标还款记录</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
	...
	$(function(){
	  //提交表单
	     ...
	     if(window.confirm("你确定标记为已还款吗,借款的可用金额将被扣除？")){
	        $.dispatchPost('markBorrow.mht',param,function(data){
	   ...
	   $('#cirAdd').click(function(){
	       window.location.href="circulationRepayForAdd.mht";
	   });	   
	});
</script>
	</body>	
