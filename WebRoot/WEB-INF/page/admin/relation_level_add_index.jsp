	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["endDate"] = $("#endDate").val();
	   		$.dispatchPost("relationLeveladdInfo.mht",praData,initCallBack);
   		}
   		...
   		function addRelationkh(){
 			...
 			$.dispatchPost("addRelationkhId.mht",paramMap,function(data){
 				if(data=='1'){
	 			  	alert("关联成功");
	 			 window.location.href='relationLeveladdInit.mht';
	 			}else{
             		alert("关联失败");
	 			}
 			});
