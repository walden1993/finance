	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["level2Id"] = '${level2userId}';
	   		$.dispatchPost("queryAwardLevel2Info.mht",praData,initCallBack);
   		}
				...
				<div>
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<td width="150" height="28" align="center"  
								class="xxk_all_a3">
								<a href="queryLeve2SumInit.mht">经纪人提成奖励管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="150" height="28" class="${level==3?'main_alll_h3':'xxk_all_a3' }">
								<a href="queryAwardLevel23Init.mht?level2userId=${level2userId}">经纪人提成列表(投资人)</a>
							</td>
							<td width="2">&nbsp;
								
							</td>
							<td width="150" height="28" class="${level==3?'xxk_all_a3':'main_alll_h3' }">
								<a href="queryAwardLevel24Init.mht?level2userId=${level2userId}">经纪人提成列表(理财人)</a>
							</td>
							<td>&nbsp;
