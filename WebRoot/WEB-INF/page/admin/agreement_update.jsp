...
<html>
	...
	<body>
		<form id="addTeam" name="addTeam" action="updateAgreement.mht" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="150px" height="28" <s:if test="#request.type==1 || #request.type==''">class="main_alll_h2"</s:if><s:else>class="xxk_all_a"</s:else>
									>
									<a href="AgreementInit.mht?agreementType=2&provisionType=1&type=1">债权转让使用条款</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="120" <s:if test="#request.type==2">class="main_alll_h2"</s:if><s:else>class="xxk_all_a"</s:else> >
									<a href="AgreementInit.mht?agreementType=2&provisionType=2&type=2">债权转让隐私条款</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="120" height="28"<s:if test="#request.type==3">class="main_alll_h2"</s:if><s:else>class="xxk_all_a"</s:else>
									>
									<a href="AgreementInit.mht?agreementType=1&provisionType=1&type=3">借款使用条款</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="120" <s:if test="#request.type==4">class="main_alll_h2"</s:if><s:else>class="xxk_all_a"</s:else>  >
									<a href="AgreementInit.mht?agreementType=1&provisionType=2&type=4">借款隐私条款</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="120" height="28" <s:if test="#request.type==5">class="main_alll_h2"</s:if><s:else>class="xxk_all_a"</s:else>
									>
									<a href="AgreementInit.mht?agreementType=4&provisionType=1&type=5">本金保障使用条款</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="120" <s:if test="#request.type==6">class="main_alll_h2"</s:if><s:else>class="xxk_all_a"</s:else>   >
									<a href="AgreementInit.mht?agreementType=4&provisionType=2&type=6">本金保障隐私条款</a>
								</td>
