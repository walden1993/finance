...
<html>
		...
		<script>
		  ...
		  $(function(){
		     ...
		     $("#tb_sort").blur(function(){
		        var val = this.value;
		        //alert("sortId1 = "+val);
		        $.dispatchPost("isExistSortId.mht",{sort:val},function(data){
		            if(data == 1){
			...
			$("#previewButton").click(function(){
			   ...
			   $("#tr_content").val(editor_content.html());
				...
				var url="PreviewNews.mht?title="+title+"&sort="+sort+"&publishTime="+time+"&visits="+visist+"&content="+content;
	...
	<body>
		<form id="addTeam" name="addTeam" action="addNews.mht" method="post">
			<div id="right">
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
								    <s:select name="paramMap.newsType" id="newsType" list="#{0:'普通公告',1:'服务公告',2:'过期公告'}"></s:select>
								</td>
							</tr>
