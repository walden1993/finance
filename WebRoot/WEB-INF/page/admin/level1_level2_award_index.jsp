	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["enable"] = $("#enable").val();
	   		$.dispatchPost("queryLeve2AwardInfo.mht",praData,initCallBack);
   		}
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<td width="150" height="28"  class="xxk_all_a">
							...
							<td width="150" height="28"  class="main_alll_h2">
								<a href="queryLeve2AwardInit.mht?parentId=${parentId }">经纪人提成奖励</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="150" height="28"  class="xxk_all_a">
								<a href="queryLevel1level3Init.mht?level1userId=${parentId }">投资人提成奖励</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="150" height="28"  class="xxk_all_a">
								<a href="queryLevel1level4Init.mht?level1userId=${parentId }">理财人提成奖励</a>
							</td>
							<td>
								&nbsp;
							</td>
