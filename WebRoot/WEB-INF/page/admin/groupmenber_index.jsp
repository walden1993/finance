...
<html>
	<head>
	   ...
	   function initListInfo(praData) {
	   		...
	   		$.dispatchPost("queryGroupMemberInfo.mht",param,initCallBack);
   		}
   		...
   		function deleteById(ids){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "deleteGroupMemberUser.mht?id="+ids;
	 		}
   		}
   		...
   		function deleteAll(){
			...
			ids = ids.substring(0,ids.lastIndexOf(","));
		 	window.location.href = "exportUserMember.mht?id="+ids;
   		}
