					...
					<s:else>
						...
						<td>
							${idNo}
								...
								<td
									style="width: 200px; white-space: normal; word-spacing: normal; word-wrap: break-word; word-break: break-all">
									${rechargeNumber}
								</td>
								<td>
									${bankName}
								...
								<td>
									<a href="queryrechargeAdminInit.mht?id=${id}">${result==3?'审核':'查看'}</a>
								</td>
							</tr>
						</s:iterator>
					</s:else>
