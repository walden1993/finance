				...
				<div style="padding: 15px 10px 0px 10px;">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
							    <td width="100" height="28" align="center"
									class="xxk_all_a">
									<a href="circulationBorrowInit.mht">所有的流转标</a>
								</td>
								<td width="2">
								&nbsp;
							    </td>
					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<tr>
								<td colspan="2" class="blue12 left">
									借款人认证审核查看：<a href="queryPerUserCreditAction.mht?userId=${borrowCirculationDetail.userId}&userType=${borrowCirculationDetail.userType}" target="_blank" style="color: blue;"><strong>申请人认证详情查看</strong></a>
								</td>
							</tr>
							</table>
							<div id="content">
...
<script>
	$(function(){
	  //提交表单
	     ...
	     $.dispatchPost('updateBorrowCirculation.mht',param,function(data){
		   if(data.msg ==1){
		       alert('操作成功!');
