...
$.post("delcertificate.mht",param,function(data){
 ...
 $(this).attr("value","2");
  ...
  $("#but_yes").click(function(){
    $("#but_yes").attr("disabled",true);
     ...
     $.post("Updatematerialsauthindex.mht",param,function(data){
         var callBack = data.msg;
         if(data==1){
         ...
         $("#but_yes").attr("disabled",false);
           ...
           window.location.href="queryPerUserPicturMsginitindex.mht?userId=${map.id}&userType=${map.userType}&materAuthTypeId=${map.materAuthTypeId}"
         }else if(data==4){
            window.location.href="queryPerUserPicturMsginitindex.mht?userId=${map.id}&userType=${map.userType}&materAuthTypeId=${map.materAuthTypeId}"
