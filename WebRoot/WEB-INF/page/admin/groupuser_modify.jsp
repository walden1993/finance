...
<html>
		...
		<script type="text/javascript" language="javascript">
	    	$(function(){
				...
				$("#add_users").click(function(){
					...
					var result = window.showModalDialog("queryGroupUserInit.mht",window,"dialogWidth=800px;dialogHeight=600px");
				...
				//changeActionUrl("addGroup.mht","modifyGroup.mht");
			});
	...
	<body>
	<form id="editForm"  method="post" action="modifyGroup.mht" >
			<div id="right">
