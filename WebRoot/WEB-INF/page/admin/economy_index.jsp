	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["endDate"] = $("#endDate").val();
	   		$.dispatchPost("queryEconomyInfo.mht",praData,initCallBack);
   		}
   		...
   		function initCallBack(data){
		 	...
		 	$(".enable").click(function(){
		 		...
		 		if(!window.confirm("确定要解除关系吗?")){
			 		...
			 		$.dispatchPost("updateRelation.mht",{id:rId},function(data){
	      ...
	      if(callBack == undefined || callBack == ''){
		 			...
		 			ShowIframe("关联团队长","relationLevelInit.mht?id="+rId,1000,800);
		...
		function relationColumn(level2Id){//level2Id经纪人id
			ShowIframe("关联客户","relationLeveladdInit.mht?level2Id="+level2Id,1000,800);
			};
	</script>
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="main_alll_h2">
									<a href="queryEconomyInit.mht">经纪人列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<s:if test="%{#session.admin.roleId <2}">
									<td width="100" class="xxk_all_a">
										<a href="addEconomyInit.mht">添加经纪人</a>
									</td>
									<td width="2">
										&nbsp;
									</td>
