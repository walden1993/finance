...
<script type="text/javascript">
   ...
   function fff(data){
                var t = $(data).attr("ids");
		    	ShowIframe("修改",'updateaccountacton.mht?id='+t,600,300);
		    }
		    function update(f,d){
		    	var param = {};
		    	param["paramMap.id"]=d;
		    	param["paramMap.tagd"] = f;
		    	$.post("updateaccreal.mht",param,function(data){
		    ...
		    function deletes(id){
			    if(confirm("确定删除?")){
			    	window.location.href='deleteacc.mht?id='+id
				 }
		    ...
		    function updatypeId(f,d){
		    	...
		    	param["id"]=f;
		    	param["typeId"] = d;
		    	$.post("updateselect.mht",param,function(data){
		    	var callBack = data.msg;
