			...
			<tbody >
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					...
					<tr class="gvItem">
						...
						<td align="center">
							<a href="queryPerUserCreditAction.mht?userId=${id }&userType=${userType}" target="_blank" >${usrename}</a>
						</td>
						<td>
					...
					<td>
						<a href="queryPerUserPicturMsginitindex.mht?userId=${id}&userType=${userType}">查看</a>
					</td>
					</tr>
				</s:iterator>
				</s:else>
