	  ...
	  $("#province").change(function(){
	    ...
	    $("#gName").focus();
	     ...
	     $("#gName").blur(function(){
	        var val = this.value;
	        //alert("val = "+val);
	        $.dispatchPost("judgeName.mht",{userName:val},function(data){
	            if(data == 1){
	            	$("#gTip").html("请填写团队长账号");
	            }else if(data ==2){
...
function citySelectInit(parentId, regionType){
				...
				$.post("ajaxqueryRegionAdmin.mht",param,function(data){
	...
	<body>
	<form id="addAdmin" action="addGroupCaptain.mht" method="post">
			<div id="right">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="queryGroupCaptainInit.mht">团队长列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100"  class="main_alll_h2">
									<a href="addGroupCaptainInit.mht">添加团队长</a>
								</td>
								<td width="2">
								&nbsp;
							</td>
