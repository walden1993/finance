	...
	<head>
		...
		<script type="text/javascript">
			...
			function del(id){
				...
				window.location.href='deleteHelpCategory.mht?typeId='+id;
			}
			...
			function saveOrder(){
			  ...
			  $.dispatchPost("updateCategoryIndex.mht",{ids:ids},function(data){
			      if(data == 1){
			         alert("排序失败");
			         return;
			      }
				...
				<div style="padding: 15px 10px 0px 10px;">
					...
					<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100"  class="xxk_all_a">
									<a href="addHelpCategoryInit.mht">添加帮助类型</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
										...
										<tr id="${id }" class="gvItem">
											...
											<td>
												<a id="gvNews_ctl05_lbManage"
													href="queryHelpListPageInit.mht?typeId=${id}">管理列表</a>
												&nbsp;&nbsp;
												<a id="gvNews_ctl05_lbEdit"
													href="updateHelpCategoryInit.mht?typeId=${id}">编辑</a>
												&nbsp;&nbsp;
