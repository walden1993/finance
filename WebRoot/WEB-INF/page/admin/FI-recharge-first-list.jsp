...
<script type="text/javascript">
  $(function(){
      $("#excel").click(function(){      
                    window.location.href=encodeURI(encodeURI("exportRechargeFirst.mht?userName="+$("#userName").val()+"&&reStartTime="+$("#reStartTime").val()+"&&rechargeType="+$("#rechargeType").val()+"&&reEndTime="+$("#reEndTime").val()));
        });
  });
</script>
	<div>
