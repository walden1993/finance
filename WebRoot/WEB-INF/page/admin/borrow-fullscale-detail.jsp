				...
				<div style="padding: 15px 10px 0px 10px;">
					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<s:elseif test="%{borrowMFullScaleDetail.borrowWay==7}">
							债权转让借款
							</s:elseif>
								</td>
							</tr>
						...
						<s:if test="%{borrowMFullScaleDetail.borrowShow==1}">
							...
							<tr>
								<td colspan="2" class="blue12 left">
									借款人认证审核查看：<a href="queryPerUserCreditAction.mht?userId=${borrowMFullScaleDetail.userId}&userType=${borrowMFullScaleDetail.userType}" target="_blank">申请人认证详情查看</a>
								</td>
							</tr>
							<tr>
								<td colspan="2" class="blue12 left">
							...
							<s:if test="%{borrowMFullScaleDetail.firstAuditTime != null && borrowMFullScaleDetail.firstAuditTime != ''}">
							<tr>
								<td colspan="2" class="blue12 left">
									初审时间：${borrowMFullScaleDetail.firstAuditTime}
								</td>
							</tr>
							</s:if>
							<s:if test="%{borrowMFullScaleDetail.displayTime != null && borrowMFullScaleDetail.displayTime != ''}">
							<tr>
								<td colspan="2" class="blue12 left">
									发布时间：${borrowMFullScaleDetail.displayTime}
								</td>
							</tr>
							</s:if>
							<tr>
						...
						<s:hidden name="userId" value="%{borrowMFullScaleDetail.userId}"></s:hidden>
						<br />
					</div>
				</div>
			</div>
...
var falg = false;
	$(function(){
	  //提交表单
	     ...
	     $.dispatchPost('updateBorrowFullScale.mht',param,function(data){
		   ...
		   if(callBack == undefined || callBack == ''){
		       ...
		       if(callBack == 1){
		    	   falg = true;
		          alert("操作成功!");
		          window.location.href="borrowFullScale.mht";
		          return false;
		       }
		       alert(callBack);
		       falg = false;
