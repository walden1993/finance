				...
				$("#btn_save").click(function(){
				 $("#btn_save").attr("disabled",true);
					...
					$("#btn_save").attr("disabled",false);
	 				...
	 				$.dispatchPost("updateRole.mht",param,function(data){
	 					if(data.msg==1){
	 						alert("修改成功！");
						...
						<s:iterator value="rightsList.{?#this.id<0}" var="bean">
							...
							<s:iterator value="rightsList.{?#this.parentID==#bean.id}" var="sBean">
								...
								<s:iterator value="rightsList.{?#this.parentID==#sBean.id}" var="ssBean">&nbsp;&nbsp;&nbsp;
									<input class="top_${bean.id} bottom parent_${sBean.id} rightId" name="rightsId" parentId="${ssBean.parentId}"  type="checkbox" value="${ssBean.id}" />${ssBean.summary}
								</s:iterator>
