...
<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){
				 window.location.href=encodeURI(encodeURI("exportborrowStatisInterest.mht?investor="+$("#investor").val()+"&&timeStart="+$("#timeStart").val()+"&&timeEnd="+$("#timeEnd").val()));
			...
			function initListInfo(praData){
				...
				praData["paramMap.timeEnd"] = $("#timeEnd").val();
		 		$.dispatchPost("borrowStatisInterestList.mht",praData,initCallBack);
		 	}
