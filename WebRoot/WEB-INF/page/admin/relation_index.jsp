	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["endDate"] = $("#endDate").val();
	   		$.dispatchPost("queryRelationInfo.mht",praData,initCallBack);
   		}
		 	...
		 	$("#dataInfo").html(data);
				 	$(".enable").click(function(){
					 		...
					 		if(enable==1){
				 				...
				 				ShowIframe("关联经纪人","queryrelationeconomicInit.mht?id="+rId,1000,800);
				 			}
		 	});
   		}
   		//分页
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28"  class="main_alll_h2">
								<a href="queryRelationInit.mht">投资人列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
