...
<html>
	...
	<body>
		<form id="updateLinks" name="updateLinks" action="updateRelatedImgInfo.mht" method="post">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="100" class="main_alll_h2">
                                    <a href="updateRelatedImgInit.mht?id=${paramMap.id }&borrowId=${id}">修改图片</a>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                    ...
                    <div style="width: auto; background-color: #FFF; padding: 10px;">
                        <table width="100%" border="0" cellspacing="1" cellpadding="3">
                            ...
                            <tr>
                                ...
                                <td align="left" class="f66">
                                <s:radio   id="tb_id"   list="#{0:'是',1:'否'}"    name="paramMap.isa" ></s:radio>
