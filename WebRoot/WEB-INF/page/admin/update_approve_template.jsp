...
<html>
	...
	<body>
		<form id="updatetenplate" name="updatetenplate" action="updateNoticeTemplateInfo.mht" method="post">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28"  class="main_alll_h2">
									<a href="updateNoticeTemplateInit.mht?id=${bean.id}&&notice_style=${bean.notice_style}">编辑类型提醒</a>
								</td>
								<td>
									&nbsp;
								</td>
