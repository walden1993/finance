					...
					<!--   div>
						<table width="10%" border="0" cellspacing="0" cellpadding="0" >
							...
							<td width="100" height="28" class="main_alll_h2">
									<a href="emailAndMessageindex.mht">用户基本信息</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
						...
						<td id="secodetble" style="width: 60%" colspan="2">
						  <table  border="0" cellspacing="1" cellpadding="3" width="60%">
						    ...
						    <table>
							 ...
							 <!-- 
							<a style="cursor: pointer;" onclick="javascript:window.location.href='queryUserManageBaseInfoinner.mht?i=${UserMsgmap.id}';">个人基本信息</a>
							 -->
							<a href="queryUserManageBaseInfoinner.mht?i=${UserMsgmap.id}&userType=${userType}" style="cursor: pointer;">个人基本信息</a>
							</td><td>&nbsp;</td>
							...
							<a href="queryUserManageInvest.mht?i=${map.userId}&userType=${userType}" style="cursor: pointer;">投资信息</a>
							</td>
							</tr>
							</table>
							</td>
