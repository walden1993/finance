	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){	
		 		...
		 		$.dispatchPost("queryReportListPage.mht",param,initCallBack);
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteReport.mht?id="+id;
		 	}
		 	
	
   			
   			function updates(e){
   			   var url="updateReportInit.mht?id="+e;
   			   ShowIframe("修改站内信",url,600,400);
   			}
   			
   			function close(){
   			   window.location.href="queryReportListInit.mht";
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td  width="10%" height="28"  class="main_alll_h2">
								<a href="queryReportListInit.mht">用户举报</a>
							</td>
							<td width="1">
								&nbsp;
							</td>
