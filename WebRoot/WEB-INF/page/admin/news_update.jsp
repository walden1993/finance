...
<html>
		...
		<script>
			...
			KindEditor.ready(function(K) {
		     ...
		     $("#tb_sort").blur(function(){
		        ...
		        $.dispatchPost("isExistToUpdate.mht",param,function(data){
		            if(data == 1){
	...
	<s:hidden id="sort_" name="paramMap.sort"></s:hidden>
		<form id="updateTeam" name="updateTeam" action="updateNews.mht" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100"  class="main_alll_h2">
									<a href="updateNewsInit.mht?id=${paramMap.id}">修改官方公告</a>
								</td>
								<td>
									&nbsp;
								</td>
