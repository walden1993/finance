...
<html>
	<head>
	    ...
	    function updatestatus(data){
               ...
               $.post("updateMoneyInfo.mht",param,function(data){
	   ...
	   function initListInfo(praData) {
			...
			praData["paramMap.endTime"] = $("#endTime").val();
	   		$.dispatchPost("quereyGroupCloseMoneyInfo.mht",praData,initCallBack);
   		}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="150" height="28" align="center"  
								class="main_alll_h2">
								<a href="quereyGroupCloseMoneyInit.mht">团队长月结算管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
