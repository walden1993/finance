					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" class="main_alll_h2">
								<a href="advertPage.mht">页面管理</a>
							</td>
							<td width="100" height="28" class="xxk_all_a">
								<a href="gotoAdvertPage.mht">新增页面</a>
							</td>
						</tr>
					</table>
					<div
							...
							<tbody>
								<tr>
									<td class="f66" align="left" width="50%" height="36px">
										渠道简称：
										<input  name="paramMap.channelDesc" id="channelDesc" type="text"/>
										渠道编号：
										<input name="paramMap.channelCode" id="channelCode" type="text"/>
...
<script type="text/javascript">
			...
			function initListInfo(praData){
				...
				praData["paramMap.channelCode"] = $("#channelCode").val();
		 		...
		 		$.post("advertPageList.mht",praData,initCallBack);
		 	}
