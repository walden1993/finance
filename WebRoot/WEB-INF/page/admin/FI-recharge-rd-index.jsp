		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){ 
                       ...
                       window.location.href="exportBackCash.mht?userId="+userId;
			...
			function initListInfo(param){
				...
				param["paramMap.type"] = $("#type").val();
		 		$.dispatchPost("queryBackCashList.mht",param,initCallBack);
		 	}
			...
			function addRecharge(){
			  var userId = $('#userId').val();
			  window.location.href= "addBackRechargeInit.mht?userId="+userId;
			}
			
			function addWithdraw(){
			   var userId = $('#userId').val();
			  window.location.href= "addBackWithdrawInit.mht?userId="+userId;
			}
			
			function show(id){
   			  var url = "queryR_WShow.mht?rwId="+id;
					...
					<table  border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="120" height="28" class="xxk_all_a">
								<a href="queryUserCashListInit.mht">充值管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
