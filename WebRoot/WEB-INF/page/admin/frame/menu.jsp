...
<html>
	...
	<script type="text/javascript">
		if(${session.index}==-1){
			window.top.main.location.href="main.mht";
		}<%--
		if(${session.index}==-2){
			window.top.main.location.href="borrowAll.mht";
		}
		if(${session.index}==-3){
			window.top.main.location.href="userFundInit.mht";
		}
		if(${session.index}==-4){
			window.top.main.location.href="queryPersonInfolistindex.mht";
		}
		if(${session.index}==-5){
			window.top.main.location.href="queryUserManageBaseInfoindex.mht";
		}
		if(${session.index}==-6){
			window.top.main.location.href="queryNewsListInit.mht";
		}
		if(${session.index}==-7){
			window.top.main.location.href="downloadlistinit.mht";
		}
		if(${session.index}==-8){
			window.top.main.location.href="queryGroupCaptainInit.mht";
		}
		if(${session.index}==-9){
			window.top.main.location.href="loginStatisInit.mht";
		}
		if(${session.index}==-10){
			window.top.main.location.href="queryUserListInit.mht";
		}--%>
		$(function(){
