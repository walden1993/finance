	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){
		 		$.dispatchPost("queryClauseListPage.mht",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteClause.mht?commonId=" + ids;
		 	}
		 	...
		 	alert(id);
	 			...
	 			window.location.href= "deleteClause.mht?commonId="+id;
		 	}
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" align="center" bgcolor="#CC0000"
									class="white12">
									<a href="queryClauseListPageInit.mht">条款编辑管理</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" align="center" bgcolor="#8594A9" class="white12">
									<a href="addClauseInit.mht">添加条款</a>
								</td>
								<td>
									&nbsp;
								</td>
