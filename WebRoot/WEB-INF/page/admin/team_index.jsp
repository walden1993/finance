	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(praData){							    
		 		$.dispatchPost("queryTeamListPage.mht",praData,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteTeam.mht?id="+ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteTeam.mht?id="+id;
		 	}
		 	...
		 	function checkAll(e){
   			...
   			//团队预览  houli
		 	function preview(id){
		 	  var url = "previewTeamInit.mht?id="+id;
