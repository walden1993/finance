			...
			<tbody>
				...
				<s:iterator value="pageBean.page" var="bean" status="st">
					<tr class="gvItem">
					    ...
					    <td align="center">${investAmount }</td>
					    ...
					    <td align="center">${workAuditStatus }</td>
					       <td align="center">
							...
							onclick="showDetail('${bean.id }','${bean.userType}')">查看详情</a>
		...
		<tbody>
			<tr>
				<td class="blue12" style="padding-left: 8px" align="left">
					...
					全选 &nbsp;&nbsp;&nbsp;&nbsp;
					<input id="btnDel" onclick="deleteAll();" type="button" value="添加选中记录" name="btnDel" />
					<input id="btnAll" onclick="selectdbAll();" type="button" value="添加全部记录" name="btnAll" />
				</td>
			</tr>
		</tbody>
	</table>
