	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){
		 		$.dispatchPost("queryIndexRollImgInfo.mht",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteIndexRollImg.mht?commonId=" + ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteIndexRollImg.mht?commonId="+id;
		 	}
