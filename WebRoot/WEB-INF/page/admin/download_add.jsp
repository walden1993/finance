...
<html>
	<head>
		...
		var editor_content;
			...
			function downloadTypeSelectInit(typeId){
				...
				var param = {};
				param["typeId"] = typeId;
				$.post("ajaxDownloadTypeByTypeId.mht",param,function(data){
			...
			function tspecialtySelectInit(typeId){
				...
				var param = {};
				param["typeId"] = typeId;
				$.post("ajaxSpecialtyByTypeId.mht",param,function(data){
					for(var i = 0; i < data.length; i ++){
			...
			function subjectSelectInit(specialtyId){
				...
				$.post("ajaxSubjectBySpecialtyId.mht",param,function(data){
					for(var i = 0; i < data.length; i ++){
	...
	<body>
		<form id="addDownload" name="addDownload" action="adddownload.mht" method="post">
			<div id="right">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="28"  class="xxk_all_a">
									<a href="downloadlistinit.mht">资料列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" class="main_alll_h2">
									<a href="adddownloadinit.mht">添加资料</a>
								</td>
								<td>
