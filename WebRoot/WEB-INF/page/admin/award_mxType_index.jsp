	...
	<head>
	  ...
	  //加载留言信息
	   function initListInfo(praData) {
	   		...
	   		$.dispatchPost("queryAwardLevel2mxTypeInfo.mht",praData,initCallBack);
   		}  <%--
	   //加载留言信息
	   function initListInfo(praData) {
   			praData["level2userId"] = '${level2userId}';
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
								<td width="160" height="28" class="xxk_all_a2">
									<a href="queryAwardLevel2${level}Init.mht">经纪人提成奖励统计(${level==3?'投资人':'理财人' })</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								...
								<td width="150"  class="main_alll_h3">
									<a href="queryIoRInit.mht?level2userId=${level2userId }&userId=${userId}&level=${level}">产生提成奖金的投资记录</a>
								</td>
								<td>
									&nbsp;
								</td>
