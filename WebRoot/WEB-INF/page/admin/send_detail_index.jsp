	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){	
		 		...
		 		$.dispatchPost("queryMailBoxListPage.mht",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "delewmail.mht?id="+ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "delewmail.mht?id="+id;
		 	}
		 	...
		 	function checkAll(e){
   			...
   			function close(){
   			   window.location.href="queryMailBoxListInit.mht";
