...
<html>
			...
			KindEditor.ready(function(K) {
			 ...
			 $(function(){
		      ...
		      $("#tb_price").blur(function(){
		        ...
		        $.dispatchPost("isExistTeamToUpdate.mht",param,function(data){
		            if(data == 1){
	...
	<s:hidden id="sort_" name="paramMap.sort"></s:hidden>
		<form id="updateTeam" name="updateTeam" action="updateTeam.mht" method="post">
						...
						<table  border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100"  class="main_alll_h2">
									<a href="updateTeamInit.mht?id=${paramMap.id}">修改成员</a>
								</td>
								<td>
									&nbsp;
								</td>
