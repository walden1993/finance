	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){	
		 		...
		 		$.dispatchPost("queryBlacklistPage.mht",param,initCallBack);
		 	}
			...
			function del(id){
	 			...
	 			window.location.href= "deleteBlackList.mht?id="+id;
		 	}
		 	
		 	function addblacklist(){
		 		
		 	  var url="addBlackListInit.mht";
   			   ShowIframe("添加黑名单",url,600,400);
	 			
		 	}
		 	
		 	function close(){
		 	  window.location.href="queryBlacklistInit.mht";
		 	  ClosePop();
		 	}
