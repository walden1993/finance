...
<html>
	<head>
	   ...
	   function initListInfo(praData) {
	   		...
	   		$.dispatchPost("queryAwardLevel2mxType2Info.mht",praData,initCallBack);
   		}
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="queryAwardLevel2Init.mht">经纪人提成列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="120" class="xxk_all_a3">
									<a href="queryAwardLevel2mxType1Init.mht?level2userId=${level2userId }&userId=${userId}">第一部分提成奖励</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="120" class="xxk_all_a3">
									<a href="queryAwardLevel2mxType2Init.mht?level2userId=${level2userId }&userId=${userId}">第二部分提成奖励</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
