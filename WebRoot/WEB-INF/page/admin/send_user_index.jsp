	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){	
		 		...
		 		$.dispatchPost("queryUserListPage.mht",param,initCallBack);
		 	}
			...
			function checkSend(){
	 			...
	 			if(!window.confirm("是否确定选中用户要发送短信?")){
		 			return;
		 		} 
	 			...
	 			$.post("SendSMSs.mht",param,function(data){
	      ...
	      if(callBack == undefined || callBack == ''){
	 			      ...
	 			      if(data==0){
	 			        ...
	 			        window.location.href='queryUserListInit.mht';
	 			      }else if(data==2){
	 			         alert("发送失败");
	 			         window.location.href='queryUserListInit.mht';
	 			      }else if(data==1){
