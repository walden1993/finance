...
<script type="text/javascript">
			$(function(){
				...
				$(this).hide();
				   ...
				   $.dispatchPost('addRepayMentNotice.mht',param,function(data){
		              ...
		              if(callBack == undefined || callBack == ''){
		                ...
		                if(callBack == 1){
		                    alert("操作成功!");
		                    window.location.href="repaymentNoticeInit.mht?id="+id;
		                    return false;
		                }
		                alert(callBack);
		              }
			...
			function initListInfo(praData){
				praData["paramMap.id"] = '${id}';
		 		$.dispatchPost("repaymentNoticeList.mht",praData,initCallBack);
		 	}
