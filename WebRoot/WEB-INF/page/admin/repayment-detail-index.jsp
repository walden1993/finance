					...
					<div>
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<a href="lateRepayInit.mht">逾期的还款</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100" id="today" height="28"  class="xxk_all_a">
								<a href="overduePaymentInit.mht">逾期垫付</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
						...
						<table cellspacing="1" cellpadding="3">
                            ...
                            <tr>
								<td colspan="2" class="blue12 left">
									借款标题：
									<a href="${frontUrl}financeDetail.mht?id=${map.borrowId}" target="_blank">${map.borrowTitle}</a>
								</td>
							</tr>
							<tr>
								<td colspan="2" class="blue12 left">
...
<script>
	$(function(){
	  //提交表单
	     ...
	     $.dispatchPost('addCollection.mht',param,function(data){
	      ...
	      if(callBack == undefined || callBack == ''){
		                 ...
		                 alert(callBack);
		                 var rId = $("#repayId").val();
		                window.location.href = 'repaymentDetail.mht?id='+rId;
		                 }
	...
	function delCollection(id){
	    ...
	    $.dispatchPost('delCollection.mht',param,function(data){
		   var callBack = data.msg;
		   if(callBack == undefined || callBack == ''){
		                 $('#collection').html(data);
		                 $(this).show();
