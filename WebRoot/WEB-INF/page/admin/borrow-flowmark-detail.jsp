						...
						<table cellspacing="1" cellpadding="3">
							<tr>
								...
								<td class="f66 leftp200">
									<s:if test="%{borrowMFlowMarkDetail.userType ==1}">真实姓名：${borrowMFlowMarkDetail.realName}</s:if>
									<s:elseif test="%{borrowMFlowMarkDetail.userType ==2}">企业全称：${borrowMFlowMarkDetail.orgName}</s:elseif>
									<s:else>其它</s:else>
								</td>
							</tr>
							<tr>
								...
								<td class="f66 leftp200">
									用户类型：
									<s:if test="%{borrowMFlowMarkDetail.userType ==1}">个人</s:if>
									<s:elseif test="%{borrowMFlowMarkDetail.userType ==2}">企业</s:elseif>
									<s:else>其它</s:else>
								</td>
							</tr>
							<tr>
							...
							<s:elseif test="%{borrowMFlowMarkDetail.borrowWay==7}">
							债权转让借款
							</s:elseif>
								</td>
							</tr>
							...
							<s:if test="%{borrowMFlowMarkDetail.firstAuditTime==null}">
							<tr>
								<td colspan="2" class="blue12 left">
							...
							<tr>
								<td colspan="2" class="blue12 left">
									借款人认证审核查看：<a href="queryPerUserCreditAction.mht?userId=${borrowMFlowMarkDetail.userId}&userType=${borrowMFlowMarkDetail.userType}" target="_blank" style="color: blue;">申请人认证详情查看</a>
								</td>
							</tr>
							</table>
							<div id="content">
