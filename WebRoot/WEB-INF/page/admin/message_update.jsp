...
<html>
	...
	<body>
		<form id="updateTeam" name="updateTeam" action="updateMessage.mht" method="post">
						...
						<table  border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="queryMessageListInit.mht">信息管理</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100"  class="main_alll_h2">
									<a href="updateMessageInit.mht?id=${paramMap.id}">信息修改</a>
								</td>
								<td>
									&nbsp;
								</td>
