...
<html>
		...
		var flag = true;
		  $(function(){
		      //提交表单
				...
				$.post("updateBorrowType.mht",param,function(data){
	...
	<body>
		<form id="updateShovetypes" name="updateShovetypes" action="updateShoveTypeInfo.mht" method="post">
			<div id="right">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28"  class="main_alll_h2">
									<a href="updateShoveTypeInit.mht?id=${paramMap.id}">修改标种类型</a>
								</td>
								<td>
									&nbsp;
								</td>
