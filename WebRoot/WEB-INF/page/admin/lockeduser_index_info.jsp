					...
					<tr class="gvItem">
					    ...
					    <td align="center">${idNo }</td>
					     -->
					   	...
					   	<td>
					   		<a id="gvNews_ctl02_lbDelete" style="cursor: pointer;" onclick="deleteById(${bean.id })">确认启用</a>
							<a href="queryUserManageBaseInfoinner.mht?i=${id }&userType=${userType}" target="main">查看</a>
						</td>
					</tr>
				</s:iterator>
				</s:else>
