		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excelout").attr("disabled",true);
                     window.location.href=encodeURI(encodeURI("exportUserFundRecharge.mht?userId="+$("#userId").val()+"&&rechargeTime="+$("#startTime").val()+"&&statss="+$("#status").val()+"&&reType="+$("#rechargeType").val()+"&&endTime="+$("#endTime").val()));
			...
			function initListInfo(param){
				...
				param["paramMap.rechargeType"] = $("#rechargeType").val();
		 		$.dispatchPost("queryUserFundRechargeList.mht",param,initCallBack);
		 	}
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="120" height="28"  class="xxk_all_a">
								<a href="userFundInit.mht">资金管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="120" height="28"  class="xxk_all_a">
								<a href="queryAllUserFundRecordInit.mht">资金明细</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
