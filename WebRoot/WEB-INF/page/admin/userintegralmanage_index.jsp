		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){
				  $("#excel").attr("disabled",true);
				   window.location.href=encodeURI(encodeURI("exportintegralinfo.mht?username="+$("#username").val()+"&&viprecode="+$("#viprecode").val()+"&&creditcode="+$("#creditcode").val()));
			   ...
			   $("#excel").attr("disabled",false);
				...
				/*
					...
					param1["paramMap.viprecode"] = $("#viprecode").val();
					$.post("addTarge.mht",param1,function(data){
					if(data==0){
					alert("你输入的借款目的已经存在");
					}else if(data==1){
					alert("操作成功");
			...
			function initListInfo(praData){
			    ...
			    param["paramMap.userType"] = $("#userType").val();
		 		$.post("queryUserManageintegralinfo.mht",praData,initCallBack);
		 	}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" class="main_alll_h2">
								<a href="queryUserManageintegralindex.mht">用户积分</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
