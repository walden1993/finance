											...
											<table>
												<tr>
													...
													<td class="xxk_all_a1" width="100px" height="20"
														align="center">
														<a style="cursor: pointer;" href="queryUserMangework.mht?uid=${UserMsgmap.id}&userType=${userType}">工作信息</a>
													</td>
													<td>
														&nbsp;
													</td>
													<td  class="main_alll_h2" width="100px" height="20"
														align="center">
														<a style="cursor: pointer;" onclick="javascript:window.location.href='queryUserManageInvest.mht?i=${UserMsgmap.id}';" >投资信息</a></td>
												</tr>
											</table>
										</td>
									</tr>
