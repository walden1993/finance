...
<script type="text/javascript">
			$(function(){
				...
				$("#excel").attr("disabled",true);
				       window.location.href=encodeURI(encodeURI("exportforPayment.mht?inverse="+$("#inverse").attr("checked")+"&&borrowWayid="+$("#borrowWay").val()+"&&groupId="+$("#group").val()+"&&investor="+$("#investor").val()+"&&timeStart="+$("#timeStart").val()+"&&timeEnd="+$("#timeEnd").val()+"&&titles="+$("#titles").val()));
			...
			function initListInfo(praData){
				...
				//-----------
		 		$.dispatchPost("forPaymentList.mht",praData,initCallBack);
		 	}
		 	function test(){
