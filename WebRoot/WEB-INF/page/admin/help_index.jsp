		...
		<script type="text/javascript">
			...
			function initListInfo(param){
				...
				param["paramMap.typeId"] = $("#typeId").val();
		 		$.dispatchPost("queryHelpListPage.mht",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteHelp.mht?commonId=" + ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteHelp.mht?commonId="+id;
		 	}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" align="center" bgcolor="#CC0000"
								class="white12">
								<a href="queryHelpListPageInit.mht">内容列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100" align="center" bgcolor="#8594A9" class="white12">
								<a href="addHelpInit.mht">添加内容</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
