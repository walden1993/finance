		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){
				 $("#excel").attr("disabled",true);
                       ...
                       window.location.href=encodeURI(encodeURI("exportUserFundWithdraw.mht?userId="+userId+"&&applyTime="+applyTime+"&&sum="+sum+"&&statss="+statss+"&&userName="+userName+"&&endTime="+endTime));
			...
			function initListInfo(param){
				...
				param["paramMap.userId"] = $("#userId").val();
		 		$.dispatchPost("queryUserFundWithdrawList.mht",param,initCallBack);
		 	}
