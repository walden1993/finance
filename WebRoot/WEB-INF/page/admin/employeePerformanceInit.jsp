		...
		<script type="text/javascript">
			$(function(){
				...
				$("#bt_search").click(function(){
				 ...
				 if( param["paramMap.investStartTime"]>param["paramMap.investEndTime"]){
                     alert("起始日期不能小于截至日期")
                     return;
                 }
			...
			function initListInfo(praData){
		 		...
		 		$.post("employeePerformanceInfo.mht",praData,initCallBack);
		 	}
							...
							<tbody>
								<tr>
									<td class="f66" align="left" width="80%" height="36px">
										...
										可用余额时间：
                                        <input id="timeStart"  class="Wdate" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  name="paramMap.createTime" type="text"/>&nbsp;&nbsp;
									</td>
								</tr>
								<tr>
								    <td class="f66" align="left" width="80%" height="36px">
								         绩效时间：
                                        <input id="investStartTime"  class="Wdate" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  name="paramMap.createTime" type="text"/>&nbsp;&nbsp;
                                        至<input id="investEndTime"  class="Wdate" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  name="paramMap.createTime" type="text"/>&nbsp;&nbsp;
