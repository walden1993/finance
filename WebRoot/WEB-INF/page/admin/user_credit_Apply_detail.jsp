...
$(function(){
  $("#queryMsg").click(function(){
    window.location.href='queryPerUserCreditAction.mht?userId=${map.id }&userType=${map.userType}'
  });
 ...
 var flag = true;
    ...
    $.post("updateUserCreditLimit.mht",param,function(data){
      var callBack = data.msg;
       ...
       flag = true;
        ...
        flag = true;
         //审核成功
        window.location.href='querycreditindex.mht';
       }else if(data==5){
       alert("同意金额不能大于申请金额");
        $("#tb_yes").attr("disabled",false);
       flag = true;
