...
<html>
	...
	<s:hidden id="sort_" name="paramMap.sort"></s:hidden>
		<form id="accountPay" name="accountPay" action="updateAccountPay.mht" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28"  class="xxk_all_a">
									<a href="queryAccountPayInit.mht">支付管理</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" align="center"  class="main_alll_h2">
									<a href="updateAccountPayInit.mht?nid=${paramMap.nid }">编辑</a>
								</td>
								<td>
									&nbsp;
								</td>
