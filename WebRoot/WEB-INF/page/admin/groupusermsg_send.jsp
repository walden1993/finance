...
<html>
		  ...
		  $(function(){
		      ...
		      //提交表单
				$("#btn_save").click(function(){
					...
					$.dispatchPost("sendGroupMessage.mht",paramm,function(data){
						if(data == 1){
							alert("发送成功");
							window.close();
						}else if(data == -2){
	...
	<body>
		<form id="editForm" name="addTeam" action="sendGroupMessage.mht" method="post">
			<div id="right">
				<div style="padding: 15px 10px 0px 10px;">
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								<td colspan="2">
								<input type="hidden" id="pathtype" name="paramMap.pathtype" value="3"/>
