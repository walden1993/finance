	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){
		 		$.dispatchPost("queryNoticeTemplateAllList.mht",param,initCallBack);
		 	}
				...
				<div>
					...
					<tr>
							...
							<td width="100" height="28"  class="xxk_all_a">
								...
								<a href="queryNoticeStyleAllInit.mht?sid=1">站内信提醒设置</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							...
							<td width="100" height="28"  class="xxk_all_a">
								...
								<a href="queryNoticeStyleAllInit.mht?sid=2">短信提醒设置</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							...
							<td width="100" height="28"  class="xxk_all_a">
								...
								<a href="queryNoticeStyleAllInit.mht?sid=3">邮件提醒设置</a>
							</td>
							<td width="2">
									&nbsp;
								</td>
							...
							<s:if test="#request.notice_style==1 || #request.notice_style == 0">
								<td width="100" height="28"  class="main_alll_h2">
									<a href="queryNoticeTemplateAllInit.mht?notice_style=${notice_style }&&id=${id}">站内信管理设置</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
							...
							<s:if test="#request.notice_style==2">
								<td width="100" height="28"  class="main_alll_h2"
									class="white12">
									<a href="queryNoticeTemplateAllInit.mht?notice_style=${notice_style }&&id=${id}">短信管理设置</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
							...
							<s:if test="#request.notice_style==3">
								...
								<a href="queryNoticeTemplateAllInit.mht?notice_style=${notice_style }&&id=${id}">邮件管理设置</a>
							</td>
							</s:if>
							<td>
