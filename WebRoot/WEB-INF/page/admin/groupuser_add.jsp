		...
		<script type="text/javascript" language="javascript">
	    	$(function(){
				...
				$("#add_users").click(function(){
					var result = window.showModalDialog("queryGroupUserInit.mht",window,"dialogWidth=1200px;dialogHeight=600px");
					//var result = window.open('queryGroupUserInit.mht','newwindow','width=800,height=600,left=400,top=150,resizable=yes');
				...
				$("#add_user").click(function(){
					...
					$.dispatchPost("queryUserIdByUserName.mht",praData,function(data){
						if(data ==''){
							alert("请正确添加用户!");
							return false;
							}
				...
				changeActionUrl("addGroup.mht","updateGroup.mht");
			});
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66" >
									<input type="checkbox" id="w_status" name="paramMap.cashStatus"  value="1" checked/>启用
								</td>
							</tr>
							<!-- end -->
							<tr>
