		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){
				  window.location.href=encodeURI(encodeURI("exportupdatephonex.mht?username="+$("#username").val()+"&&endtime="+$("#endtime").val()+"&&starttime="+$("#starttime").val()));
				});
			...
			function initListInfo(praData){
		 		$.post("updatePlatformCostbyIdInfo.mht",param,initCallBack);
		 	}
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" class="xxk_all_a">
								<a href="showPlatformCostInit.mht">平台收费管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100"  class="main_alll_h2">
								<a href="updatePlatformCostbyIdInit.mht?id=${id}">修改收费参数</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
