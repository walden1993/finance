				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<td align="center">
							...
							<td>
							<a href="queryManageDebtDetail.mht?id=${id}&paramMap.borrowerName=${borrowerName}&paramMap.borrowTitle=${borrowTitle}&paramMap.alienatorName=${alienatorName }" target="main"> 查看</a> 		
					</td></tr>
				</s:iterator>
				</s:else>
				<tr >
