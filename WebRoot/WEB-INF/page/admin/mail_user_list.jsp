	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){	
		 		...
		 		$.dispatchPost("queryMailBoxListUserPage.mht",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "delewmailuser.mht?id="+ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "delewmailuser.mht?id="+id;
		 	}
		 	//加入黑名单
		 	function black(id){
		 	  if(!window.confirm("您确定把该会员加入站内信黑名单吗？")){
		 		...
		 		window.location.href= "joinBlackList.mht?id="+id;
		 	}
		 	...
		 	function checkAll(e){
   		    ...
   		    function updates(e){
   			   var url="updateMailInit.mht?id="+e;
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td id="admins" width="100"  class="xxk_all_a">
								<a href="queryMailBoxListInit.mht">管理员与用户</a>
							</td>
							<td width="1">
								&nbsp;
							</td>
							<td id="adusers" width="100" class="main_alll_h2">
								<a href="queryMailBoxListUserInit.mht">用户与用户</a>
							</td>
							<td width="1">
								&nbsp;
							</td>
							<td id="blacklist" width="100" class="xxk_all_a">
								<a href="queryBlacklistInit.mht">黑名单</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
