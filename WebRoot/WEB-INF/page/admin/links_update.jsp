...
<html>
	...
	<body>
		<form id="updateLinks" name="updateLinks" action="updateLinks.mht" method="post">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
                            ...
                            <tr>
                                ...
                                <td align="left" class="f66">
                                    ...
                                    <span class="require-field">*(由小到大排列)<s:fielderror fieldName="paramMap['serialCount']"></s:fielderror></span>
                                </td>
                            </tr>
							<tr>
								<td style="width: 100px; height: 25px;" align="right"
