...
<html>
	...
	<script>
	   ...
	   /*  $("#investManger").click(function(){
	        ...
	        $.post("showCostType.mht","type=2",function(data){
	     ...
	     */
	     ...
	     //VIP会费设置
	       $("#vipmanager").click(function(){
	        ...
	        $.post("showCostType.mht","type=4",function(data){
	     ...
	     //好友推荐奖励设置
	      /* $("#referral").click(function(){
	        ...
	        $.post("referralBonusesList.mht","",function(data){
	        ...
	        //手续费
	         $("#formalities").click(function(){
                ...
                if((/^[1-4]{1,2}(\.\d{1,4})?$/.test(number))){
                  $.post("updateCostManager.mht","number="+number+"&typeId=1",function(data){
                     if(data==1){
                      alert("修改成功");
                     }else if(data==2){
                     alert("修改失败");
