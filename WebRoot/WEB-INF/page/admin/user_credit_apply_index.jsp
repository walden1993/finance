	     ...
	     /*
			...
			*/
			...
			param["paramMap.userType"] = $("#userType").val();
	   		...
	   		$.post("querycreditinofor.mht",param,initCallBack);
   		}
							...
							<td class="f66" align="left" width="50%" height="36px">
							    ...
							    <input id="endtime"  class="Wdate" name="paramMap.endtime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly'})"/>&nbsp;&nbsp; 
							    	...
							    	<s:select list="#{-1:'请选择',1:'个人',2:'企业'}"  name="paramMap.userType" id="userType" ></s:select>&nbsp;&nbsp;
									 状态：<s:select list="#{-1:'请选择',3:'成功',2:'失败',1:'审核中'}" theme="simple" value="#request.types" name="paramMap.materAuthTypeId" id="materAuthTypeId" ></s:select>&nbsp;&nbsp;
