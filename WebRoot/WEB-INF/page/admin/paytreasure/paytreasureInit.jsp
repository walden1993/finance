	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(praData){
		 		...
		 		$.post("paytreasureInfo.mht",praData,initCallBack);
		 	}
					...
					<div
						...
						<table style="margin-bottom: 8px;" cellspacing="0" cellpadding="0"
							...
							<tbody>
								...
								<tr class="f66" align="left" width="80%" height="36px">
									<td>
										涨薪宝当前资金总额：${sumPayInvest.amount}元，涨薪宝总发放收益：${sumPayInvest.profit}元，涨薪宝总转入：${sumPayInvest.inamount}元，涨薪宝总转出：${sumPayInvest.outamount}元
									</td>
								</tr>
							</tbody>
						</table>
