	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(praData){
		 		...
		 		$.post("payInvestRecordAllList.mht",praData,initCallBack);
		 	}
							...
							<tbody>
								<tr>
									<td class="f66" align="left" width="80%" height="36px">
										用户名 ：
										<input id="userName" name="paramMap.userName"  style="width: 100px;"type="text"/>&nbsp;&nbsp;
										真实姓名 ：
										<input id="realName" name="paramMap.realName" style="width: 100px;" type="text"/>&nbsp;&nbsp;
										操作类型：<s:select list="#{'':'--请选择--',1:'转入',2:'转出'}"  id="type"></s:select>
										操作时间 ：
					<input type="text" id="publishTimeStart" name="publishTimeStart" style="width: 100px;" value="${paramMap.publishTimeStart}" class="input_border w50" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly',maxDate:'#F{$dp.$D(\'publishTimeEnd\')}'})" readonly="">&nbsp;-&nbsp;<input type="text" id="publishTimeEnd" name="publishTimeEnd"  style="width: 100px;" value="${paramMap.publishTimeEnd}" class="input_border w50" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly',maxDate:'%y-%M-%d'})" readonly="">
