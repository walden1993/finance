  ...
  <div class="w950 wdzh">
	...
	<div class="r_main fr w750 mb">
       ...
       <div class="uesr_border personal clearfix h500"  align="center">
        	 <s:form action="wageExoportEmployee.mht"  id="sendWage"  enctype="multipart/form-data"  method="post">
            <table>
                <tr height="60">
                    <td align="right" class=""><h5>导入薪水清单：</h5></td>
	...
	<script type="text/javascript">
		...
		function downModel(){
			window.location.href = encodeURI(encodeURI("downLoadWageExoportEmployeeModel.mht"));
		}
		$(function(){
			$("#bind").click(function(){
				$("#sendWage").submit();
