...
<html lang="zh-cn">
<head>
<c:set value="三好资本问答" var="title" scope="request"></c:set>
...
$(function(){
    ...
    queryMtbd1(param);
    //queryMtbd2(param);
    $(".html_left a:eq(8)").addClass("hover");
})
...
function queryMtbd1(parDate){
    ...
    param["label"] = label;
    $.post("queryMediaReportListPage3.mht",parDate,function(data){
        $("#shd").html("");
        $("#shd").html(data);
   });
}
    ...
    document.title='p2p网贷问答_专业解答P2P网贷平台问答-三好资本p2p投资理财平台';
</script>
</body>
</html>
