...
<div class="tabtil">
       <ul><li class="on">我关注的借款</li></ul>
        ...
        <div class="boxmain2">
         <div class="srh">
       	 <form action="borrowConcernList.mht" id="searchForm" >
...
<div  class="page" >
	     <shove:page url="borrowConcernList.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
...
function del(obj){
     ...
     var initCallBack;
     if(confirm("确定删除?")){
     $.post("delBorrowConcern.mht",param,function(pageBean){
