...
<%@include file="/include/taglib.jsp" %>
    <div class="biaoge mt20" id="re_biaoge">
      <table width="100%" border="0" class="table table-striped" cellspacing="0" cellpadding="0">
		  <tr>
		    <th><input type="checkbox" name="checkbox" id="checkbox6" onclick="checkAll_Receive(this)" /></th>
		    <th>标记</th>
		    <th>发件人</th>
		    <th colspan="6">标题</th>
		    <th>发送时间</th>
		  ...
		  <s:if test="pageBean.page!=null && pageBean.page.size>0">
		       ...
		       <s:if test="#bean.mailStatus=='未读'">
		         <tr>
			      <td align="center"><input type="checkbox" value="${bean.id}"  onclick="cacel3()"   name="receiveMail" id="checkbox2" class="re" /></td>
