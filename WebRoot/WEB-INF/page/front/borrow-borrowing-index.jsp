...
<div class="wrap nymain">
  <div class="wdzh w950">
      ...
      <!-- /div -->
    <div class="r_main fr w750">
      <div class="tabtil">
        <ul>
        <li  onclick="goUrl('homeBorrowAuditList.mht')">审核中的借款</li>
        <li class="on" onclick="goUrl('homeBorrowingList.mht')">招标中的借款</li>
        </ul>
        </div>
<div class="box">
        <div class="boxmain2">
         <div class="srh">
          <form action="homeBorrowingList.mht" id="searchForm" >
  ...
  <tr>
	...
	<s:iterator value="pageBean.page" var="bean">
	 <tr>
		<td align="center"><a href="financeDetail.mht?id=${bean.id}">${bean.borrowTitle}</a></td>
    	<td align="center">
  ...
  <div  class="page" >
	     <shove:page url="homeBorrowingList.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
