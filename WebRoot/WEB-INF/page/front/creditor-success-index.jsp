...
<div class="tabmain">
  <ul><li onclick="goUrl('queryFrontAllDebt.mht');">全部债权列表</li><li class="on">最近成功的债权转让</li>
  </ul>
    </div>
    </div>
    <div class="line">
  ...
  <div class="lcmain" >
    <div class="lcmain_l"  style="float:none; margin-left:0px; width:auto;">
		 <div class="zqsrh">
     <form id="searchForm" action="queryFrontSuccessDebt.mht">
 ...
 <s:if test="pageBean.page==null || pageBean.page.size<=0">
  ...
  <tr>
    <td align="center" width="80"><a href="userMeg.mht?id=${alienatorId}" target="_blank">${alienatorName}</a></td>
    <td class="tx"><a href="userMeg.mht?id=${publisher}" target="_blank" >
    <shove:img src="${personalHead }" defaulImg="images/hslogo_42.jpg" width="80" height="79"></shove:img></a>
      &nbsp;<a href="userMeg.mht?id=${publisher}" target="_blank">${borrowerName }</a>&nbsp; <img src="images/ico_${creditratingIco }.jpg" title="${creditrating }分" /></td>
    ...
    <div  class="page" >
     <shove:page url="queryFrontSuccessDebt.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
    ...
    //样式选中
	 ...
	 $("#jumpPage").click(function(){
	  ...
	  $("#btn_title_search").click(function(){
	 	window.location.href = "queryFrontSuccessDebt.mht?borrowTitle="+$("#borrowTitle").val();
	 });
});		     
