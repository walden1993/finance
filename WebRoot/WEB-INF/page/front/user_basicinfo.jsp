	    ...
	    $.post("updateBasedate.mht",param,function(data){
	       if(data.msg=="保存成功"){
	        ...
	        $("#workdate").addClass("on");
	      	...
	      	$.dispatchPost("queryWorkInit.mht",null,function(data){
		        $("#workdi").html(data);
		    });*/
	       window.location.href = 'owerInformationInit.mht?yy=c2';
	       }else{
	         //alert("请正确填写基本资料");
...
<div class="boxmain2">
    ...
    -->
				...
				<tr>
					...
					<td>
						<input type="button" id="btn_personalHead" class="scbtn" style="cursor: pointer;" value="点击上传"
							<s:if test='#request.map.auditStatus ==3'>disabled="disabled"</s:if> />
					</td>
				</tr>
				<tr>
