    ...
    <div class="r_main">
      <div class="tabtil">
       <ul><li id="lab_1" onclick="jumpUrl('homeBorrowInvestList.mht');">成功借出</li>
        ...
        <li id="lab_4" class="on" onclick="jumpUrl('homeBorrowRecycledList.mht');">已回收的借款</li>
...
<div class="box">
        <div class="boxmain2">
         <div class="srh">
         <form action="homeBorrowRecycledList.mht" id="searchForm" >
...
<div  class="page" >
	     <shove:page url="homeBorrowRecycledList.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">	    
...
function viewDetail(obj,obj1){
    var url = "homeBorrowHaspayDetail.mht?id="+obj+"&iid="+obj1;
    $.jBox("iframe:"+url, {
        title: "还款详情",
        width: 800,
        height: 500,
