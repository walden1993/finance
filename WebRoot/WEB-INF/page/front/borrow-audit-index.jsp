...
<div class="wrap nymain">
  <div class="wdzh w950">
    ...
    <div class="r_main fr w750">
      <div class="tabtil">
        <ul>
        <li class="on" onclick="goUrl('homeBorrowAuditList.mht')">审核中的借款</li>
        <li onclick="goUrl('homeBorrowingList.mht')">招标中的借款</li>
        </ul>
        </div>
<div class="box">
        <div class="boxmain2">
         <div class="srh">
          <form action="homeBorrowAuditList.mht" id="searchForm" >
  ...
  <div  class="page" >
	     <shove:page url="homeBorrowAuditList.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
...
$(function(){
    //样式选中
     ...
     $('#search').click(function(){
        ...
        if(!isBlank($("#titles").val())){
        	if( isSpace.test($("#titles").val())){
        		 alert("请正确输入关键字");
                 return;
        	}
        }
