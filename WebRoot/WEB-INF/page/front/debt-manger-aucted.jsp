  ...
  <div class="wdzh">
    <div class="l_nav">
      ...
      <div class="tabtil">
       ...
       <li class="on" onclick="goUrl('queryAuctedDebt.mht');">竞拍结束的债权</li>
...
<div class="box" >
        <div class="boxmain2">
        <form id="searchForm" action="queryAuctedDebt.mht">
   ...
   <s:if test="pageBean.page==null || pageBean.page.size() == 0">
    ...
    <s:else>
	  <s:iterator value="pageBean.page" var="bean">
		...
		<td align="center">
		    	   <a  href="protocol.mht?typeId=24&borrowId=${bean.borrowId }&investId=${bean.investId}&aid=${bean.debtId}" target="_blank">转让协议 </a></td>
		  </tr>
	  </s:iterator>
  </s:else>
          </table>
<div class="page">
    		...
    		<shove:page url="queryAuctedDebt.mht" curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
...
<script>
   ...
   function showAgree(investId,borrowId){
	     var url = "queryAboutInfo.mht?msg=24&&borrowId="+borrowId+"&&investId="+investId+"&&styles=1";
