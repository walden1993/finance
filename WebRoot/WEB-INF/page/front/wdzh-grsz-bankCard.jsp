	...
	<body>
      ...
      <!-- /div -->
					...
					<div class="tabtil">
						<ul>
							...
							<li id="li_tx" class="on"
								onclick="jumpUrl('queryBankInfoInit.mht');">
								银行卡设置
							</li>
						</ul>
					</div>
							...
							<div class="biaoge2" style="margin-top: 0px;">
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										...
										<td class="txt">
											<strong>注：尊敬的用户，您在三好资本网的相关操作， 三好资本网会用以上三种方式<br />通知您，请您选择适合自己的通知方式！
		...
		<script type="text/javascript"
			src="${path}/script/jquery-2.0.js"></script>
  ...
  function jumpUrl(obj){
		         ...
		         $("#reClickCode").click(function(){
		           ...
		           if($("#mobile2").val()==""){
	                 ...
	                 if($("#reClickCode").html()=="重新发送验证码"||$("#reClickCode").html()=="发送手机验证码") {  
	                    $.post("sendSMS.mht","phone="+phone,function(data){
	                       if(data==1){
	                          rtimers=60;
	...
	$(function(){
		...
		$("#workdate").click(function(){
		   $.post("queryWorkInit.mht",null,function(data){
		       $("#workdi").html(data);
		  });
			...
			$("#infomationdata").click(function(){
		       ...
		       $.post("queryBasicInit.mht",null,function(data){
	...
	//登录密码修改
	   ...
	   function loadBankInfo(){
	      $.dispatchPost("queryBankInfoInit.mht",null,function(data){
	       /* alert(${li_type});
	        if(${li_type}=="1"){
		        $.post("queryBasicInit.mht",null,aa);
	        }else{*/
 			    $("#bankInfo").html(data);
 			 //}
 		  });
	   ...
	   function del(id){
	 	...
	 	function addBindingMobile(){
	 	   if($("#mobile").val()==""){
		 	 ...
		 	 $.dispatchPost("addBindingMobile.mht",param,function(data){
			                   ...
			                   param["paramMap.otherName"]=$("#otherName").val();
			                    param["paramMap.otherRelation"]=$("#otherRelation").val();
			                     param["paramMap.otherTel"]=$("#otherTel").val();
			                      ...
			                      param["paramMap.moredName"]=$("#moredName").val();
			                    $.post("updatework.mht",param,function(data){
			                          if(data.msg=="保存成功"){
			                            alert("保存成功");
