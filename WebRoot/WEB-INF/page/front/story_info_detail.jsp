  ...
  <div class="lcmain">
    ...
    <ul>
     <li>
       <s:if test="#request.previousDate!=null" >
          上一条：<a style="max-width: 30px;overflow: hidden;"  href="frontQuerySuccessStoryDetail.mht?id=${request.previousDate.id}">${request.previousDate.title}</a>
       </s:if>  
       <s:else>
         <a>&nbsp;&nbsp;&nbsp;</a>
       </s:else>
    ...
    <li>
      <s:if test="#request.lastDate!=null" >
         下一条：<a style="max-width: 30px;overflow: hidden;" href="frontQuerySuccessStoryDetail.mht?id=${request.lastDate.id}">${request.lastDate.title}</a>
      </s:if> 
      <s:else>
        <a>&nbsp;&nbsp;&nbsp;</a>
      </s:else>  
