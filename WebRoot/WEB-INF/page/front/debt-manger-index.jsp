...
<div class="nymain">
  <div class="wdzh">
    <div class="l_nav">
      ...
      <div class="r_main">
      <div class="tabtil">
        <ul><li class="on" onclick="goUrl('queryCanAssignmentDebt.mht')">可以转让的借款</li>
        <li onclick="goUrl('queryAuctingDebt.mht');">竞拍中的债权</li>
      ...
      <div id="debt_add" class="xzzl">
         ...
         <form id="searchForm" action="queryCanAssignmentDebt.mht">
  ...
  <tr>
   ...
   <s:iterator value="pageBean.page" var="bean">
	  <tr>
	    ...
	    <td align="center"><fmt:formatNumber value="${ hasPI}" type="number" pattern="0.00" /></td>
	    <td align="center"><fmt:formatNumber value="${recievedPI-hasPI}" type="number" pattern="0.00" /></td>
	    <td align="center">
	    ...
	    <td align="center">
	    	...
	    	<s:elseif test="#bean.debtStatus==1">
	    		<a href="cancelApplyDebt.mht?debtId=${debtId}" >撤回</a>
	    	</s:elseif>
	    </td>
	  </tr>
  	</s:iterator>
 ...
 <div class="page">
    	<shove:page url="queryCanAssignmentDebt.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
...
<script>
   $(function(){
	...
	function addAssignmentDebt(borrowId,debtSum,debtLimit,investId){
		$("#zrzq_div").attr("style","");
		$(".boxmain2").attr("style","overflow-y: auto;")
		$("#debtSum").val(debtSum);
