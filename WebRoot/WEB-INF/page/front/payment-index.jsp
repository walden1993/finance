...
$(function(){
	...
	function borrowSuccessInit(){
	   ...
	   $.dispatchPost("mySuccessBorrowInit.mht",param,function(data){
	...
	function borrowPayingInit(){
	  ...
	  param["pageBean.pageNum"]=1;
	  $("#borrow_details").html("");
	  $.dispatchPost("queryMySuccessPayingInit.mht",param,function(data){
	...
	function borrowAllDetailsInit(){
	  param["pageBean.pageNum"]=1;
	  $.dispatchPost("queryAllDetailsInit.mht",param,function(data){
	...
	function borrowInvestorDetailsInit(){
	  param["pageBean.pageNum"]=1;
	  $.dispatchPost("queryBorrowInvestorInit.mht",param,function(data){
	...
	function borrowPayOffInit(){
	  ...
	  $.dispatchPost("queryPayoffListInit.mht",param,function(data){
