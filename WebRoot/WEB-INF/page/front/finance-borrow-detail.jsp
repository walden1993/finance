        				...
        				<div class="m20">
						 ...
						 <s:if test="%{#request.related !=null && #request.related.size()>0}"><li role="presentation"><a href="#cailiao" aria-controls="cailiao" role="tab" data-toggle="tab">相关材料</a></li></s:if>
						  ...
						  <div class="tab-content">
						    ...
						    <div class="small_list_title"><h4 class="title p0 h0">借款方信息</h4></div>
						    <div class="plan_tab_con mt30">
						          <table width="100%" class="table" border="0" cellspacing="0">
         					 <tr>
                                <td>
                                  		  性别：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span><s:property  value="#request.borrowUserMap.sex" default="未填写" /></span>
                                    </s:if>
                                ...
                                <td colspan="2">
                                    婚姻状况：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span>${borrowUserMap.maritalStatus}</span>
                                    </s:if>
                            ...
                            <tr>
                            	<td>
                                    ...
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span>${borrowUserMap.workPro}&nbsp;${borrowUserMap.workCity}</span>
                                    </s:if>
                                ...
                                <td>
                                    公司行业：
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span>${borrowUserMap.companyLine}</span>
                                    </s:if>
                                ...
                                <td>
                                    公司规模：
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span>${borrowUserMap.companyScale}</span>
                                    </s:if>
                            ...
                            <tr>
                                <td>
                                    毕业学校：
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span>${borrowUserMap.school}</span>
                                    </s:if>
                                ...
                                <td>
                                    学历：
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span>${borrowUserMap.highestEdu}</span>
                                    </s:if>
                                ...
                                <td colspan="2">
                                    入学年份：
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span>${borrowUserMap.eduStartDay}</span>
                                    </s:if>
                            ...
                            <tr>
                                <td>
                                    有无购房：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span>${borrowUserMap.hasHourse}</span>
                                    </s:if>
                                ...
                                <td>
                                    有无购车：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span>${borrowUserMap.hasCar}</span>
                                    </s:if>
                                ...
                                <td>
                                    有无房贷：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span>${borrowUserMap.hasHousrseLoan}</span>
                                    </s:if>
                                ...
                                <td>
                                    有无车贷：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span>${borrowUserMap.hasCarLoan}</span>
                                    </s:if>
    ...
    <div class="plan_tab_con clearfix">
          ...
          <tr>
                                <td>
                                   企业名称：
                                    ...
                                    <shove:sub suffix="*" value="#request.borrowUserMap.orgName " size="2"/>
                                        <span><shove:sub suffix="*******" value="#request.borrowUserMap.orgName " size="2"/></span>
                                    </s:if>
                                ...
                                <td>
                                    法人代表：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span><shove:sub suffix="***" value="#request.borrowUserMap.legalPerson " size="1"/></span>
                                    </s:if>
                            ...
                            <td>
                                   注册地址：
                                    <s:if test="#request.borrowUserMap.auditperson == 3">
                                        <span><shove:sub suffix="*************" value="#request.borrowUserMap.address " size="2"/></span>
                                    </s:if>
                                ...
                                <td>
                                    联系电话：
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span><shove:sub suffix="*******" value="#request.borrowUserMap.phone " size="3"/></span>
                                    </s:if>
                            ...
                            <tr>
                                <td colspan="2">
                                   营业执照号：
                                    <s:if test="#request.borrowUserMap.auditwork == 3">
                                        <span><shove:sub suffix="*******" value="#request.borrowUserMap.regNum " size="3"/></span>
                                    </s:if>
