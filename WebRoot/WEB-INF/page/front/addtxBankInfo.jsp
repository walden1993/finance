...
<head>
	...
	<c:set value="添加银行卡" var="title" scope="request" />
  <style>
  .bank {
...
<body>
		  ...
		  <tr>
		    ...
		    <td><input type="password" class="inp188"  id="dealpwd"/>
		      <span class="txt"><i class="red">*非银行卡交易密码,<a  href="searchDealPwdSetp1.mht" id="searchDealPwd"  class=" fancybox.ajax" >忘记交易密码?</a></i></span><br /></td>
		  </tr>
		 </table>
		 <div class="control-group text-center">
		    <span style="color: red; float: none;" id="bk1_tip" class="formtips"></span>
            <span id="bankInfo" ></span><br />
            <input type="button" class="button w100 mr20" id="addbank" value="添加"/>
            <input type="button"  class="button_over w100" id="addbankquxiao" value="取消"/>
      </div>
