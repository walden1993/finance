  ...
  <div class="wdzh">
    ...
    <div class="r_main">
      <div class="tabtil">
        ...
        <li id="lab_2" class="on" onclick="jumpUrl('homeBorrowTenderInList.mht');">招标中的借款</li>
...
<div class="box">
        <div class="boxmain2">
         <div class="srh">
        <form action="homeBorrowTenderInList.mht" id="searchForm" >
...
<div  class="page" >
	     <shove:page url="homeBorrowTenderInList.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
