...
<html>
	...
	document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion="
			+ Math.ceil(new Date() / 3600000)
						...
						<p>
							<a id="focusonBorrow" href="javascript:void(0);">关注此融资</a>
						</p>
					</div>
					<div class="xqbox">
						<h3>
							...
							<div class="xqtop">
								<div class="money">
									<p>
										...
										</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;融资目的：${borrowDetailMap.purpose
										}
									</p>
									<p>
										融资年利率：
    	 ...
    	 到期还本付息
					...
					<div class="reninfo">
						...
						<div class="rinfomain">
							<div class="tx">
								<shove:img src="${borrowUserMap.headJpg}"
							...
							<div class="">
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										...
										<td>
											${borrowUserMap.username1}
											<s:if test="#request.borrowUserMap.v ipStatus ==2"></s:if>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td width="70" style="width: 70px !important;" align="right">
											信用指数：
										</td>
										<td>
	...
	$(function() {
		...
		var new_address = user_address.substring(0,5);
