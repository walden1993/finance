...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><input name="input" type="text" name="paramMap.code" id="cod" class="inp90" value="${paramMap.code}"/>
       <img src="admin/imageCode.mht?pageId=code" title="点击更换验证码" style="cursor: pointer;"
...
$(function(){
     $('#savetbn2').click(function(){
         ...
         $.dispatchPost('reportAdd.mht',param,function(data){
		     if(data.msg == 1){
		       alert('举报成功');
...
function switchCode2(){
	    ...
	    $('#codeNum2').attr('src','admin/imageCode.mht?pageId=code&d='+timenow);
};	
</script>
</body>
</html>