...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <s:if test="pageBean.page!=null || pageBean.page.size>0">
    ...
    <td align="center" class="tx">
    	<a href="financeDetail.mht?id=${finance.id}" title="<s:property value="#finance.borrowTitle" default="---"/>"><img src="${finance.imgPath}" width="80" height="79" /></a></td>
    <td align="center" class="bt"><h2>
    <s:if test="#finance.hasPWD == 1">
    	<img src="images/lock.png" width="16" height="16" />
    </s:if>
    <a href="financeDetail.mht?id=${finance.id}" title="<s:property value="#finance.borrowTitle" default="---"/>">
...
<!--
    ...
    window.location.href="bidlist.mht?curPage="+curPage+"&pageSize=${pageBean.pageSize}";
	});
//-->
</script>