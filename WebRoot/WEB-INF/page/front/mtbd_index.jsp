...
$("#links").click(function(){
    ...
    $.post("frontQueryMediaReportdList.mht","",function(data){
         ...
         $(".boxmainss").append("<div class='clear'></div>");
...
function doMtbdJumpPage1(i){
	...
	function queryMtbd1(parDate,newsType){
		 $.post("queryMediaReportListPage.mht?newsType="+newsType,parDate,function(data){
	         $("#showcontent").html("");
	         $("#showcontent").html(data);
	    });
	}
