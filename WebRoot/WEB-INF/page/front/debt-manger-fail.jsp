    ...
    <div class="l_nav">
      ...
      <div class="tabtil">
       ...
       <li onclick="goUrl('queryAuctedDebt.mht');">竞拍结束的债权</li>
        <li class="on" onclick="goUrl('queryAuctionFailDebt.mht');">转让失败的债权</li>
        </ul>
        </div>
...
<div class="box" >
        <div class="boxmain2">
         <form id="searchForm" action="queryAuctionFailDebt.mht">
...
<div class="page">
    	...
    	<shove:page url="queryAuctionFailDebt.mht" curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
