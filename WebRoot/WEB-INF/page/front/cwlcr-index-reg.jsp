...
<div class="nymain">
  ...
  <tr>
    <td colspan="2" align="center">绑定身份证、手机号码即可成为三好资本理财人</td></tr>
  <tr>
  ...
  <tr>
    <th align="right">&nbsp;</th>
    <td class="tyzc"><a href="rechargeInit.mht">我要充值</a> <a href="queryFundrecordInit.mht">账户余额</a></td>
  </tr>
  <tr>
    <th align="right">&nbsp;</th>
  ...
  <tr>
    <td colspan="2" align="left" style="line-height:26px; padding-top:15px; color:#888;">注意：若第一次验证失败，三好资本身份证号码不匹配。   第二次验证，将按审核成本5元/次的标准收取验证费，请务必填写您的真实信息！进行手机绑定后，本手机号将作为三好资本和您确认贷款的途径之一，请使用您常用的手机号码进行绑定，您的手机号码不会以任何形式被泄露。</td>
    </tr>
    </table>
</form>
    </div>
...
<jsp:include page="/include/footer.jsp"></jsp:include>
 <script type="text/javascript" src="${path}/script/jquery-2.0.js"></script>
...
$(function(){
	...
	function addBecomeFinancer(){
	  ...
	  if($("#realName").val()=="" || $("#cellPhone").val()=="" ||
		...
		$.dispatchPost("addBecomeFinance.mht",param,function(data){
		     if(data==7){
...
//.....................................
			...
			window.location.href='financerWaiting.mht';
			/*$("#realName").attr("value","");
