...
<%@include file="/include/taglib.jsp" %>
  <s:if test="#request.mapList.size>0">
    ...
    <li>
            <div class="list_tx"><a href="financeDetail.mht?id=${finance.id}"><img src="${finance.imgPath}" width="80" height="79" /></a></div>
            <div class="list_txt">
              <table width="510" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <th colspan="3" align="left"><a href="financeDetail.mht?id=${finance.id}" title="<s:property value="#finance.borrowTitle" default="---"/>"><s:property value="#finance.borrowTitle" default="---"/></a></th>
                </tr>
                <tr>
