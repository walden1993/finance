    ...
    //样式选中
	 ...
	 $("#btn_img").click(function(){
	  ...
	  $("#savebtn").click(function(){
	       ...
	       $.dispatchPost("renewalVIPSubmit.mht",param,function(data){
		       if(data.msg = 'VIP续费成功'){
		    	   alert(data.msg);
...
function uploadCall(basepath,fileName,cp){
	if(cp == "img"){
		...
		$.dispatchPost("updatePersonImg.mht",param,initCallBack);
	}
}
...
function switchCode(){
	    ...
	    $('#codeNum').attr('src','admin/imageCode.mht?pageId=code&d='+timenow);
};
</script>
</body>
</html>
