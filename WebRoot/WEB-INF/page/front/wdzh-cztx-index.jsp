...
<div class="nymain">
  <div class="wdzh">
    ...
    <div class="tabtil">
        <ul>
        <li class="on" onclick="jumpUrl('queryFundrecordInit.mht');">资金记录</li>
        <li  onclick="jumpUrl('rechargeInit.mht');">充值</li>
...
<script>
   ...
   function addRechargeInfo(){
      ...
      var money = $("#money").val();
      window.open("alipayPayment.mht?divType=li_2&money="+money);
      
      /*param["paramMap.money"] = $("#money").val();
      $.dispatchPost("addRechargeInfo.mht",param,function(data){
         if(data == 0){
            alert("充值失败");
            return ;
         }
