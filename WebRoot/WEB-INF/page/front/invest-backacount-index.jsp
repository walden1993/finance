  ...
  <div class="wdzh">
    ...
    <div class="r_main">
      <div class="tabtil">
        ...
        <li id="lab_3" onclick="jumpUrl('homeBorrowRecycleList.mht');">回收中的借款</li>
        <li id="lab_4" onclick="jumpUrl('homeBorrowRecycledList.mht');">已回收的借款</li>
        <li id="lab_5" class="on" onclick="jumpUrl('homeBorrowBackAcountList.mht');">回账查询</li>
        </ul>
        </div>
<div class="box">
        <div class="boxmain2">
  ...
  <tr>
    ...
    <td align="center" id="allForPI">￥<s:if test="#request.backAcountStatisMap.allForPI !=''">${backAcountStatisMap.allForPI}</s:if><s:else>0</s:else></td>
         ...
         <div class="srh">
        <form action="homeBorrowBackAcountList.mht" id="searchForm" >
  ...
  <tr>
	...
	<s:iterator value="pageBean.page" var="bean">
	 <tr>
    	...
    	<a href="protocol.mht?typeId=1&&borrowId=${bean.borrowId }&&investId=${bean.investId }&&styles=1" target="_blank">查看协议</a>
    	   </td>
       </tr>
     </s:iterator>
	</s:else>
...
<div  class="page" >
	     <shove:page url="homeBorrowBackAcountList.mht" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
...
function showAgree(borrowId,invest_id){
    var url = "protocol.mht?typeId=15&&borrowId="+borrowId+"&&investId="+invest_id+"&&styles=1";
