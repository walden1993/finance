...
<div class="nymain">
  ...
  <div class="sqdk" style="padding-top:55px; padding-bottom:80px; padding-left:60px;">
   ...
   <tr>
    ...
    <s:if test="#session.DEMO==1">*　演示站点不发送短信，请随意填写</s:if><s:else>
   			 三好资本向您的手机发送了一条短信校验码，请立即查收!
   			 </s:else>
    </span>
    </td>
  </tr>
...
function regg(){
             ...
             var errornum=$("form .onError").length;
		         ...
		         $.post("cellreginfo.mht",param,function(data){
		           ...
		           $("#s_userName").html("用户名不能含有特殊字符"); 
		            ...
		            falg = true;
                     ...
                     alert("该手机号码已经注册了");	
                     window.location.href='cellPhoneinit.mht';
                     //将手机短信验证码移除
                     $.post("removecellCode.mht","",function(data){});//删除手机验证码
		           }
		            ...
		            alert("恭喜你!注册成功");
		            $.post("removecellCode.mht","",function(data){
