...
<div class="pub_tb bottom"><h3>三好资本问答</h3></div><div class="clearfix"></div>
<div class="m20">
    ...
    <s:iterator value="pageBean.page" var="bean">
                 <dl class="mt_dl">
        <dt><a href="frontMedialinkId.mht?id=${bean.id}"  target="_blank">
        <img src="${bean.imgPath}" width="160" height="80" />
        </a></dt>
        <dd>
