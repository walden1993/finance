...
<form id="form" action="addBorrowSeconds.mht" method="post">
<div class="nymain">
...
$(function(){
	 ...
	 $("#btn_personalHead").click(function(){
			...
			//var json = "{'fileType':'JPG,BMP,GIF,TIF,PNG'}";
			json = encodeURIComponent(json);
			//window.showModalDialog("uploadFileAction.mht?obj="+json,window,"dialogWidth=500px;dialogHeight=400px");
			//var returnValue = window.showModalDialog("uploadFileAction.mht?obj="+json,window,"dialogWidth=500px;dialogHeight=400px");
			window.open('uploadFileAction.mht?obj='+json,'newwindow','width=480,height=200,left=400,top=150,resizable=yes');
