...
<%@include file="/include/taglib.jsp" %>
    ...
    <div class="boxmain">
      ...
      <ul>
       ...
       <li>
        <div class="pic">
          <a href="userMeg.mht?id=${message.userId}" target="_blank"><img src="<s:property value="#message.personalHead"/>" width="62" height="62" /></a></div>
          <div class="lyinfo">
  ...
  <s:else>
    ...
    <div class="page" style=" padding-top:20px;">
                    <p>
                       <shove:page url="borrowmessage.mht" curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="jsNumber" totalCount="${pageBean.totalNum}">
...
$(function(){
     $('#savetbn').click(function(){
         ...
         $.dispatchPost('addDebtMSG.mht',param,function(data){
		     if(data.msg == 1){
		       initListInfo(param);
		     }else{
		       $('#msgadd').html(data);
...
function switchCodes(){
	    ...
	    $('#codeNums').attr('src','admin/imageCode.mht?pageId=msg&d='+timenow);
};	
</script>