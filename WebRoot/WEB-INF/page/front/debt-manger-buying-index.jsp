...
<div class="r_main">
      <div class="tabtil">
        <ul><li class="on" onclick="goUrl('queryBuyingDebt.mht')">参与购买的债权</li>
        <li onclick="goUrl('querySucessBuyedDebt.mht')">已成功购买的债权</li>
        </ul>
        </div>
      <div class="box">
        <div class="boxmain2">
        <form id="searchForm" action="queryBuyingDebt.mht" >
    ...
    <s:else>
	  ...
	  <tr>
	    ...
	    <s:if test="#bean.auctionCount<2">
	    	<s:if test="#bean.debtStatus == 2">
	    <a href="auctingDebtInit.mht?debtId=${debtId }">出价</a></s:if></s:if><a href="queryDebtDetail.mht?id=${debtId }" target="_blank"> 查看</a></td>
	  </tr>
	  </s:iterator>
  </s:else>
          </table>
<div class="page"> 
    	<shove:page url="queryBuyingDebt.mht" curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
