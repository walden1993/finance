  ...
  <div class="sqdk" style=" margin:20px auto; width:910px">
    <div class="jk">
      <div class="jkimg">
       ...
       <p class="jkbtnbox">
       <a href="addBorrowInit.mht?t=1" class="jzbtn">净值借款</a> 
       <a href="addBorrowInit.mht?t=2" class="mhbtn">秒还借款</a> 
       <a href="addBorrowInit.mht?t=0" class="qtbtn">其它借款</a></p> 
    </div>
    <div class="jk" style="margin-right:0px;">
      <div class="jkimg">
        <img src="images/neiye5_13.jpg" width="420" height="322" /></div>
       <p class="jkbtnbox"><a href="creditingInit.mht" class="sqxybtn">申请信用额度</a></p> 
    </div>
  </div>
  </div>
</div>
