...
<div class="nymain">
  ...
  <tr>
    ...
    <img src="admin/imageCode.mht?pageId=cellphone" title="点击更换验证码" style="cursor: pointer;"
  ...
  <tr>
    <th align="right">&nbsp;</th>
   <!--  <td><a href="yxjihuo.mht" class="zcbtn">免费注册</a></td> -->
...
<script type="text/javascript" src="script/jbox/jquery.jBox-zh-CN.js"></script>
  ...
  //弹出隐私条款和使用条款
 function fff(){
		    	  jQuery.jBox.open("post:querytips.mht", "使用条款", 600,400,{ buttons: { } });
		    }
		    function ffff(){
		      ClosePop();
		    }
...
<script>
 function ffftip(){
	 jQuery.jBox.open("post:querytip.mht", "隐私条款", 600,400,{ buttons: { } });
		    }
</script>
  <script>
//回车登录
 ...
 if($(this).attr("id")=="code"){
  ...
  <script>
		...
		function switchCode(){
			...
			$("#codeNum").attr("src","admin/imageCode.mht?pageId=cellphone&d="+timenow);
		}
  </script>
  <script>
   var falg = true;
  function cellreg(){
   var errornum=$("form .onError").length;
              if(falg){
               ...
               $.post("cellPhoneregsinit.mht",param,function(da){
               if(da==1){
                 ...
                 if('${DEMO}'!=1){
                     ...
                     $.post("phoneCheck.mht","phone="+phone+"&code="+code,function(datas){
                    	    ...
                    	    test["paramMap.pageId"] = "cellphone";//只有手机注册页面需要pageId
                    	            ...
                    	            $.post("sendSMSNew.mht",test,function(data){

                    	                if(data==1){
                    	                	window.location.href='cellPhonereginit.mht';
                    	                }else{
                    	                alert("手机验证码发送失败");
                    	                }
