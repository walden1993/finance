...
<div class="zqmain">
  <div class="l-nav">
  <h2 style="padding-left:0px;"><a href="queryFrontAllDebt.mht">查看债权转让列表</a></h2>
  <div class="question">
  <h3>相关问题 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  
  <a href="callcenter.mht?type=true&cid=5"  >    更多>></a></h3>
  <div class="qt-main">
  ...
  <s:if test="#request.lists ==null || #request.lists.size<=0">
    ...
    <ul >
	    <s:iterator value="#request.lists"  var="bean">
		     <li>
		     <a href="callcenter.mht?type=true&cid=5">${bean.questionDescribe }</a>
		      </li>
	    </s:iterator>
     </ul>
    </s:else>
