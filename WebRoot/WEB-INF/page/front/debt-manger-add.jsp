...
<%@include file="/include/taglib.jsp" %>
  ...
  <tr>
   ...
   <tr>
    <th align="right">交易密码：<strong style="color: red;">*</strong>&nbsp;&nbsp;</th>
    <td><input type="password" class="inp90" name="paramMap.dealpwd" id="dealpwd"" />
    <strong style="color: red;"><s:fielderror fieldName="paramMap.dealpwd" /></strong>
    </td>
  </tr>
  <tr>
...
var flag = true;
   $(function(){
   		...
   		$("#debt_ok").click(function(){
             ...
             if(flag){
              flag = false;
   			$.dispatchPost("addAssignmentDebt.mht",para,function(data){
   				if(data == 1){
   					alert("操作成功");
   					$("#debt_cancel").click();
   					$("#btn_search").click();
