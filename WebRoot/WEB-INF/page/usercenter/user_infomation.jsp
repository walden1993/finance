			...
			<div class="bigbox">
				...
				<div class="sqdk" style="background: none;">
					<div class="l-nav">
						<ul>
							<li class="on">
								<a href="information.mht">基本资料</a>
							</li>
							<li>
								<a href="userPassData.mht">上传资料</a>
							</li>
							<li class="last">
								<a href="sqdk-fbdk.mht">发布贷款</a>
							</li>
						</ul>
					</div>
					<div class="r-main">
 ...
 //============
     ...
     */
	   ...
	   var param = {};
	    ...
	    $.post("userBaseDate.mht",param,function(data){
	       if(data.msg=="保存成功"){
	       window.location.href='againJumpToUserInf.mht';
	        alert("保存成功");
			                   ...
			                   param["paramMap.otherName"]=$("#otherName").val();
			                    param["paramMap.otherRelation"]=$("#otherRelation").val();
			                     param["paramMap.otherTel"]=$("#otherTel").val();
			                      ...
			                      param["paramMap.moredName"]=$("#moredName").val();
			                    $.post("userWorkDate.mht",param,function(data){
			                          if(data.msg=="保存成功"){
			                            alert("保存成功");
			                            window.location.href='againJumpToUserInfo.mht';
			                          }
