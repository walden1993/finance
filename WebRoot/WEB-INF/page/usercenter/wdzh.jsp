...
<div class="top">
  ...
  <div class="login"> <a href="zhuce.mht">注册</a> <span>-</span> <a href="login.mht">登录</a> <span>|</span> <a href="#" class="kf">客服</a> </div>
</div>
<div class="nav">
  <div class="nav_left"> </div>
  <div class="nav_main">
    <ul>
      <li id="sy_hover"><a href="<%=application.getAttribute("basePath")%>">首页</a>
      ...
      <li id="licai_hover"><a href="wylc.mht">我要理财</a>
      ...
      <li id="jk_hover"><a href="wyjk.mht">我要借款</a>
      ...
      <li id="zh_hover" class="navact"><a href="wdzh.mht">我的账户</a></li>
      <li id="bj_hover"><a href="bjbz.mht">本金保障</a></li>
      <li id="kf_hover"><a href="kfzx.mht">客服中心</a></li>
...
<div class="nymain">
  <div class="wdzh">
    <div class="l_nav">
      <div class="box">
      <div class="til"><h2>我的三好资本</h2></div>
      <ul><li class="fir on"><a href="#">我的主页</a></li>
<li><a href="#">充值提现</a></li>
<li><a href="#">三好资本认证</a></li>
<li><a href="#">站内信</a></li>
<li><a href="#">个人设置</a></li>
<li><a href="#">好友管理</a></li>
</ul>
