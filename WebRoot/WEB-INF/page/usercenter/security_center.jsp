...
<c:set value="安全中心"  var="title"  scope="request" />
...
<div class="wrap  mb20">
  <div class="w950 wdzh">
	...
	<div class="r_main fr w750 mb">
		<div class="pub_tb bottom"><h3>安全中心</h3></div><div class="clearfix"></div>
         <div class="uesr_border personal">
            ...
            <ul class="safety">  
                  ...
                  <li class="list">
                   <div class="clearfix top_tit">
                    ...
                    <s:else>
                      <span class="plaint"></span>
                       ...
                       <div class="info">定期更换密码可以让你的账户更加安全</div>
                       <div class="tir" ><a href="javascript:void(0)" myvalue="1" class="blue" id="fixFun1">设置</a></div>
                   </div>
                   <div id="box1" class="mt15"  style="display:none">
                       <ul class="safe_list">
                       <li class="clearfix">
                            <div class="til"><span class="red">*</span>原密码：</div>
                            <div class="info"><input type="password" maxlength="16" id="oldPassword" placeholder="输入您现在的账号登录密码" class="input_border w200" /></div>
                       </li>
                       <li class="clearfix">
                            <div class="til"><span class="red">*</span>新密码：</div>
                            <div class="info"><input type="password" maxlength="16" id="newPassword" placeholder="输入您的新密码" class="input_border w200" /></div>
                       </li>
                       <li class="clearfix">
                            <div class="til"><span class="red">*</span>确认新密码：</div>
                            <div class="info"><input type="password" maxlength="16" id="confirmPassword" placeholder="请再次输入您的新密码" class="input_border w200" /></div>
                       </li>
                       <li class="clearfix">
                            <div class="til">&nbsp;</div>
                            <div class="info"><input id="loginSubmit" onclick="updateLoginPassword();" type="button" value="提 交" class="button w140" /> </div>
                       </li>
                       <li class="clearfix">
                       		<div class="til">&nbsp;</div>
                   ...
                   <div class="clearfix top_tit">
                       <!--未验证-->
                       <s:if test="#request.dealpwd != null && #request.dealpwd !='' && #request.password!=#request.dealpwd">
                       <span class="success"></span>
                       </s:if>
                       <s:else>
                         <span class="plaint"></span>
                       </s:else>
                       <div class="til">交易密码</div>
                       <s:if test="#request.dealpwd != null && #request.dealpwd !='' && #request.password!=#request.dealpwd">
                         <!--验证成功--><div class="info gray3">投资或提现时输入，保护账户资金安全</div>
                       </s:if>
                       <s:else>
                         <!--未验证--><div class="info gray6">投资或提现时输入，保护账户资金安全，您还未设置</div>
                       </s:else>
                       <div class="tir"><a href="javascript:void(0)"  myvalue="1" class="blue" id="fixFun2">设置</a></div>
                   </div>
                        <div id="box2" class="mt15"  style="display:none">
                           <ul class="safe_list">
                           <li class="clearfix">
                            <div class="til"><span class="red">*</span>原密码：</div>
                            <div class="info"><input type="password" maxlength="16" id="oldDealpwd" placeholder="输入您现在的账号交易密码" class="input_border w200" /><span class="ml20">首次交易密码与登录密码相同！</span>
                            </div>
                       </li>
                       <li class="clearfix">
                            <div class="til"><span class="red">*</span>新密码：</div>
                            <div class="info"><input type="password" maxlength="16" id="newDealpwd" placeholder="输入您的新密码" class="input_border w200" /></div>
                       </li>
                       <li class="clearfix">
                            <div class="til"><span class="red">*</span>确认新密码：</div>
                            <div class="info"><input type="password" maxlength="16" id="confirmDealpwd" class="input_border w200" placeholder="请再次输入您的新密码" /></span></div>
                       </li>
                       <li class="clearfix">
                            <div class="til">&nbsp;</div>
                            <div class="info"><input onclick="updateDealPassword();" id="loginSubmit" type="button" value="提 交" class="button w140" />&nbsp;&nbsp;
                             <a href="searchDealPwdSetp1.mht" id="searchDealPwd"  class="ln26 blue   fancybox.ajax">忘记交易密码?</a> 
                            </div>
                       </li>
                       <li class="clearfix">
                       		<div class="til">&nbsp;</div>
                   ...
                   <div class="clearfix top_tit">
                       ...
                       <s:if test="#request.authCardName == 0">
						 <!--验证成功-->
						 <div class="info gray3">您已通过实名认证</div>
						 <div class="tir"><a href="javascript:void(0)" myvalue="1" class="blue" id="fixFun3">查看</a></div>
						</s:if>
						<s:else>
						 <!--未验证-->
						 <div class="info gray6">您尚未通过实名认证，为了您的账户安全请及时认证</div>
						 <div class="tir"><a href="#" myvalue="1" class="blue" id="fixFun3">认证</a></div>
						</s:else>
                   </div>
                   <s:if test="#request.authCardName == 0">
				   ...
				   <div id="box3" class="mt15" style="display:none">
                           ...
                           <li class="clearfix">
                                ...
                                <div class="info"><input id="realName" maxlength="10" placeholder="请输入您的真实姓名" type="text" class="input_border w200" />
                                <span style="color: red; float: none;"  id="u_realName" class="formtips"></span>
                                </div>
                           </li>
                           <li class="clearfix">
                                <div class="til"><span class="red">*</span>身份证号码：</div>
                                <div class="info"><input id="idNo" type="text" maxlength="20" placeholder="请输入您的身份证号码" class="input_border w200" />
                                <span style="color: red; float: none;" id="u_idNo" class="formtips"></span>
                                </div>
                           </li>
                           <li class="clearfix">
                                <div class="til">&nbsp;</div>
                                <div class="info"> <input id="identifierSubmit" onclick="identifier();" type="button" value="提 交" class="button w140"/></div>
                           </li>
                           <li class="clearfix">
								<div class="til">&nbsp;</div>
                   ...
                   <div class="clearfix top_tit">
                       ...
                       <s:if test="#request.mobilePhone != null && #request.mobilePhone !=''">
                         <!--验证成功--><div class="info gray3">您当前绑定的手机：
                         <b class="ml5">
                         ${mobilePhone}
                       ...
                       <s:else>
                         <!--未验证--><div class="info gray6">您还未绑定手机</div>
                       </s:else>
                       <div class="tir"><a href="javascript:void(0)"  myvalue="1" class="blue" id="fixFun4">设置</a></div>
                   </div>
                        <div id="box4" class="mt15" style="display:none;">
                           <ul class="safe_list">
                           <li class="clearfix">
                                <div class="til"><span class="red">*</span> 新手机号码：</div>
                                <div class="info"><input type="text" maxlength="11" id="mobile2" class="input_border w200" placeholder="请输入新的手机号码"  maxlength="11"/>
                           ...
                           <li class="clearfix">
                                ...
                                <a href="searchDealPwdSetp1.mht" id="searchDealPwd"  class="ln26 blue   fancybox.ajax">忘记交易密码?</a></div>
                           </li>
                           <li class="clearfix">
                                <div class="til">&nbsp;</div>
                                <div class="info"><input onclick="addChangeBindingMobile();" id="smsChange" type="button" value="提 交" class="button w140"/></div>
                           </li>
                           <li class="clearfix">
                                <div class="til">&nbsp;</div>
                   ...
                   <div class="clearfix top_tit">
                       ...
                       <s:if test="#request.email != null && #request.email !=''">
                         <!--验证成功--><div class="info gray3">您当前绑定的邮箱：<b class="ml5">${email }</b></div>
                       </s:if>
                       <s:else>
                         <!--未验证--><div class="info gray6">您还未绑定邮箱</div>
                       </s:else>
                       <div class="tir"><a href="javascript:void(0)" myvalue="1" class="blue" id="fixFun5">设置</a></div>
                   </div>
                        <div id="box5" class="mt15" style="display:none;">
                           ...
                           <li class="clearfix">
                                <div class="til">&nbsp;</div>
                                <div class="info"><input id="emailSubmit" onclick="emailSubSave();" type="button" value="提 交" class="button w140"/></div>
                           </li>
                           <li class="clearfix">
                                <div class="til">&nbsp;</div>
                   ...
                   <div class="clearfix top_tit">
                       <span class="success"></span>
                       <div class="til">系统通知</div>
                       <div class="info">您在三好资本网的相关操作，系统会以站内信、邮件、短信的方式通知您</div>
                       <div class="tir"><a href="javascript:void(0)" myvalue="1" class="blue" id="fixFun6">设置</a></div>
                   </div>
                        <div id="box6" style="display:none;" class="mt15 text-center">
                           <ul class="safe_list">
                           <li class="clearfix">
                           ...
                           <li class="clearfix mt20 ">
                                <div class="til">&nbsp;</div>
                                <div class="info text-left"><input name="input" type="button" value="提 交" class="button w140" onclick="addNoteSetting();"/> </div>
                           </li>
                           </ul>                        
                       </div>
                   </li>
