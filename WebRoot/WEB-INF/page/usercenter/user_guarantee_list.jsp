...
<div class="tabmain">
  ...
  <tr>
    ...
    <div class="fenye">
    <div class="fenyemain">
    <a href="index.mht">首页</a>   <a href="#">上一页</a>  <a href="#" class="yema on">1</a> <a href="#" class="yema">2</a> <a href="#" class="yema">3</a> <a href="#" class="yema">4</a> <a href="#" class="yema">5</a> <a href="#" class="yema">..</a> <a href="#">下一页</a>   <a href="#">末页</a>   共 10/100 条记录   转到<select><option>1</option></select> 页</div>
    </div>
    </div>
    </div>
  </div>
