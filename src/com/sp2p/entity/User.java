...
public class User implements Serializable  {
	...
	private String orgheadimg;//公司头像
	...
	public String toString() {
		return "User [authStep=" + authStep + ", balances=" + balances
				+ ", creditLimit=" + creditLimit + ", dealpwd=" + dealpwd
				+ ", email=" + email + ", enable=" + enable + ", encodeP="
				+ encodeP + ", headImage=" + headImage + ", id=" + id
				+ ", imgHead=" + imgHead + ", isApplyPro=" + isApplyPro
				+ ", isLoginLimit=" + isLoginLimit + ", kefuid=" + kefuid
				+ ", kefuname=" + kefuname + ", lastIP=" + lastIP
				+ ", lastTime=" + lastTime + ", loginErrorCount="
				+ loginErrorCount + ", orgName=" + orgName + ", password="
				+ password + ", personalHead=" + personalHead + ", realName="
				+ realName + ", servicePerson=" + servicePerson + ", userName="
				+ userName + ", userType=" + userType + ", orgheadimg=" + orgheadimg + ", vipStatus="
				+ vipStatus + ", virtual=" + virtual + "]";
	}
