...
public class IConstants {
    ...
    public static final String HOME="http://www.sanhaodai.com";
	 ...
	 * 注册企业全称重复
	 */
	public static final String USER_REGISTER_REPEAT_ORGNAME = "31";
	/**
	 * 手机号码全称重复
	 */
	public static final String USER_REGISTER_REPEAT_PHONE="32";
	...
	public static String MAIL_SEND_DATE="";
	public static String ISDEMO="";
	public final static int MAIL_AMOUNT = 90;
	...
	static{
		...
		merchantId=pf.read("merchantId");
		terminalId = pf.read("terminalId");
		certPassword = pf.read("certPassword");
		//新浪常量初始化
...
//		RENREN_OAUTH_URL = pf.read("renren_oauth_url");
	 ...
	 * 借款类型 7 债权转让借款
	 */
	public static final String BORROW_TYPE_TRANSFER = "7";
	
	
    public static final String BORROW_TYPE_NET_VALUE_STR = "净值借款";
    public static final String BORROW_TYPE_NET_VALUE_INT = "借款人可以发布的不超过其平台账号净值额度的借款金额，但借款人提现将受到限制。这是一种安全系数相对较高的借款标，因此利率方面可能比较低。净值标通常用于临时周转，使资金利用率最大化。";//净值借款说明
    
    public static final String BORROW_TYPE_SECONDS_STR = "秒还借款";
    public static final String BORROW_TYPE_SECONDS_INT = "借款人标满瞬间送出利息，免手续费、自动审核、自动还款，不定期送出秒还标。";
    
    public static final String BORROW_TYPE_GENERAL_STR = "信用借款";
    public static final String BORROW_TYPE_GENERAL_INT = "信用借款标是一种将个人的信用运用于借款之中，免抵押、免担保的小额个人信用贷款标，SP2P网贷通过严格审核，对借款人给予信用评级，授予信用额度，允许其在平台发布贷款信息。主要面向对象一般为18-60周岁有稳定收入，具有较强偿还能力的公民。";
    
    public static final String BORROW_TYPE_FIELD_VISIT_STR = "实地考察借款";
    public static final String BORROW_TYPE_FIELD_VISIT_INT = "小微企业现场考察审批融资；汽车、房产、货物等融资；逾期24小时内赔付。";
    
    public static final String BORROW_TYPE_INSTITUTION_GUARANTEE_STR = "机构担保借款";
    public static final String BORROW_TYPE_INSTITUTION_GUARANTEE_INT = "是指三好资本的合作伙伴为相应的借款提供连带保证，并负有连带保证责任的借款。 （机构担保标需要通过机构担保认证）";
    
    public static final String BORROW_TYPE_INSTITUTION_FLOW_STR = "流转标借款";
    public static final String BORROW_TYPE_INSTITUTION_FLOW_INT = "";
    
    public static final String BORROW_TYPE_TRANSFER_STR = "债权转让标";
    public static final String BORROW_TYPE_TRANSFER_INT = "债权转让（CreditAssignment）债权转让又称“债权让与”，是指在不改变合同内容的合同转让，债权人通过债权转让第三人订立合同将债权的全部或部分转移于第三人。";
	...
	public static final String BORROW_STATUS_4_STR = "已满标";
...
//	public static final int BANK_CHANGE = 4;
	 ...
	 * 不收取短信手续费
	 */
	public static final float NOTE_CHARGE = 0f;
	...
	public static final String FUNDMODE_RECHARGE_AUTO = "自动充值";
	
	public static final String FUNDMODE_WITHDRAW_HANDLE = "手动扣费";
	
	public static final String FUNDMODE_WITHDRAW_AUTO = "自动扣费";
	 ...
	 * 企业机构担保ID
	 */
	public static final long COMGUARANTEE = 34;
	 ...
	 * 实地考察ID
	 */
	public static final long COMFIELD_VISIT = 20;
	...
	static{
    	...
    	EXTMAP.put(3, "doc,docx,xls,xlsx,ppt,htm,html,txt,zip,rar,gz,bz2");//file
