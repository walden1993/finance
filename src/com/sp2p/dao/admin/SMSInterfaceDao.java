...
public class SMSInterfaceDao {
	 ...
	 */
	public Long updateSMS(Connection conn,Integer id,String UserID,String Account,String Password,String status,String url,String isMarket)throws SQLException,DataException{
		...
		sms.isMarket.setValue(isMarket);
