...
public class EmalAndMessageDao {
	...
	public Long addMailSet(Connection conn, String mailaddress,
		...
		return mailset.insert(conn);//.update(conn, "");
	}
	
	public Long addMailSetu(Connection conn, int id,String mailaddress,
			String mailpassword, String sendmail, String sendname,String port,String host)
			throws SQLException, DataException {
		Dao.Tables.t_mailset mailset = new Dao().new Tables().new t_mailset();
		mailset.mailaddress.setValue(mailaddress);
		...
		mailset.port.setValue(port);
		mailset.host.setValue(host);
		return mailset.update(conn, " id="+id);//.update(conn, "");
	}
	/**
	 * 新增系统参数类型
	 * addSyspar
	 ...
	 * Long
	 * @exception 
	 * @date:2014-9-2 上午8:33:14
	 * @since  1.0.0
	 */
	public Long addSyspar(Connection conn,String typeName){
	    Dao.Tables.t_selecttype selecttype= new Dao().new Tables().new t_selecttype();
	    selecttype._name.setValue(typeName);
	    return selecttype.insert(conn);
	}
     ...
     * @since  1.0.0
     */
    public Long addSyspar(Connection conn,String typeName,String introduce){
        Dao.Tables.t_selecttype selecttype= new Dao().new Tables().new t_selecttype();
        selecttype._name.setValue(typeName);
	 ...
	 * @throws DataException
	 */
	public Long deleteMail(Connection conn, Long id) throws SQLException,
			DataException {
		Dao.Tables.t_mailset select = new Dao().new Tables().new t_mailset();
	 ...
	 * Long
	 * @exception 
	 * @date:2014-9-2 下午6:13:29
	 * @since  1.0.0
	 */
	public Long updateSysparChild(Connection conn,String id,String selectName,String selectValue,String deleted,String introduce){
	    Dao.Tables.t_select select = new Dao().new Tables().new t_select();
	 ...
	 * 删除系统参数类型
	 */
	public Long deleteSyspar(Connection conn,String id){
	    Dao.Tables.t_selecttype selecttype = new Dao().new Tables().new t_selecttype();
	    return selecttype.delete(conn, " id ="+Utility.filteSqlInfusion(id));
	}
	/**
     * 删除某类型系统参数
     */
    public Long deleteSysparChild(Connection conn,String id){
        Dao.Tables.t_select select = new Dao().new Tables().new t_select();
        return select.delete(conn, " id ="+Utility.filteSqlInfusion(id));
    }
	/**
	 * 删除系统头像
	 * 
	...
	public Long deletSImage(Connection conn, Long id) throws SQLException,
		...
		return sysImages.delete(conn, " id = " + id);
	}
