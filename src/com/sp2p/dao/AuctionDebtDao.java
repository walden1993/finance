...
public class AuctionDebtDao {
	...
	//根据企业用户Id获取企业用户信息
	public Map<String, String> getOrgAddressById(Connection conn, long userId) throws SQLException, DataException {
		Dao.Tables.t_orginfo t_orginfo= new Dao().new Tables().new t_orginfo();
		DataSet ds = t_orginfo.open(conn, "*", "user_id="+userId, "", -1, -1);
		return BeanMapUtils.dataSetToMap(ds);
	}
