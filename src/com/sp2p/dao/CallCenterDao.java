...
public class CallCenterDao {
	...
	*/
	...
	public List<Map<String,Object>> queryAnswerByTypeId(Connection conn, long typeid) throws SQLException, DataException{
		Dao.Views.v_t_callcenter_help_list t_helpAnswer = new Dao().new Views().new v_t_callcenter_help_list();
		DataSet dataSet = t_helpAnswer.open(conn, " typeDescribe,question,anwer", " typeId=" + typeid, "", -1, -1);
		dataSet.tables.get(0).rows.genRowsMap();
		return dataSet.tables.get(0).rows.rowsMap;
	}
