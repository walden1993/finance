...
public class SelectedDao {
	 ...
	 * @exception 
	 * @date:2014-9-27 下午10:05:12
	 * @since  1.0.0
	 */
	public Map<String, String> getSyspar(Connection conn,String pmcd) throws DataException{
	    Dao.Tables.t_select select = new Dao().new Tables().new t_select();
	    DataSet ds =  select.open(conn, "*", " selectKey = '"+pmcd+"'", "", -1, -1);
