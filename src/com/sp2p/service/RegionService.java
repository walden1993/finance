...
public class RegionService extends BaseService {
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> queryRegionListApp(String cityname,
			Long parentId, Integer regionType,String bank_name) throws Exception {
		Connection conn = MySQL.getConnection();
		List<Map<String, Object>> listMap = null;
		try {
			listMap = regionDao.queryRegionListApp(conn, cityname, parentId,
					regionType,bank_name);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
			throw e;
