...
public class SDKClientProxy implements com.sp2p.sms.SDKClient {
  private String _endpoint = null;
  private com.sp2p.sms.SDKClient sDKClient = null;
  ...
  private void _initSDKClientProxy() {
    try {
      sDKClient = (new com.sp2p.sms.SDKServiceLocator()).getSDKService();
      if (sDKClient != null) {
        if (_endpoint != null)
  ...
  public com.sp2p.sms.SDKClient getSDKClient() {
    if (sDKClient == null)
      _initSDKClientProxy();
    return sDKClient;
  }
