...
public class SDKServiceLocator extends org.apache.axis.client.Service implements com.sp2p.sms.SDKService {
    ...
    private java.lang.String SDKService_address = "http://sdk999ws.eucp.b2m.cn:8080/sdk/SDKService";
    ...
    public com.sp2p.sms.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.sp2p.sms.SDKServiceBindingStub _stub = new com.sp2p.sms.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.sp2p.sms.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                com.sp2p.sms.SDKServiceBindingStub _stub = new com.sp2p.sms.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
